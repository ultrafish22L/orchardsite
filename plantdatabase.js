const plants = [
    // BANANAS
    {
        ...
        general_info: "Musa acuminata is a species of banana native to Southern Asia, comprising the Indian subcontinent and Southeast Asia. Many modern edible dessert bananas are derived from this species. First cultivated by humans around 8000 BCE, it is one of the early examples of domesticated plants. Musa acuminata is an evergreen, perennial, herbaceous plant growing around 3 metres tall with leaves that can be 2 metres long and 60cm wide.",
        cultivation_tips: "Plant in organically rich, medium moisture, well-drained soil in full sun. Plants tolerate and often appreciate some part shade or light filtered sun in the heat of the day. Needs consistently moist soils that do not dry out. Fertilize regularly during growing season with balanced fertilizer. Water deeply 1 to 2 times per week. Grows best in temperatures between 65-90°F, thrives in USDA zones 9-11.",
        pest_management: "Common pests include scale insects, aphids, whitefly, Chinese rose beetle, citrus swallowtail caterpillar, citrus blackfly, and citrus leaf miner. Broad mite is very prevalent and causes leaf curling. Beneficial insects help control certain pests. Avoid overwatering which can lead to root rot. Watch for fungal diseases in wet conditions.",
        pruning_guidelines: "Remove dead or damaged leaves regularly. After fruiting, cut back the main pseudostem to allow new growth to emerge from 'pups' or shoots that grow around the base. Each pseudostem has a limited lifespan - it only lives as long as it takes to flower and produce fruit. Pruning is generally limited to removing dead leaves as the plant does not require extensive shaping."
    },
    {
        ...
        general_info: "The Dwarf Cavendish is a compact variety of Musa acuminata that fits well in home gardens and containers. It grows to 5-10 ft tall and can be grown as a summer bedding plant or in a container. Award-winning for its manageable size and fruit production, it's one of the most popular banana varieties for home cultivation.",
        cultivation_tips: "Requires full sun to partial shade, organically rich soil with good drainage. Water regularly but allow soil to dry slightly between waterings. Fertilize with balanced fertilizer every 4-6 weeks during growing season. Can be grown in containers and brought indoors in cooler climates. Needs temperatures above 60°F to thrive.",
        pest_management: "Watch for scale, aphids, and spider mites especially when grown indoors. Good air circulation helps prevent fungal issues. Remove any damaged foliage promptly to prevent disease spread.",
        pruning_guidelines: "Remove dead or yellowing leaves by cutting close to the main stem. After fruiting, cut the pseudostem down to ground level to allow new shoots to develop. Regular removal of excess suckers helps focus energy on fruit production."
    },
    {
        name: "Lactan Banana",
        botanical: "Musa acuminata",
    ...
    // CITRUS
    {
        ...
        general_info: "Lemons are citrus fruits that originated in subtropical South and Southeast Asia. They are among the most popular citrus for home gardens, particularly the Meyer lemon variety which is very adaptable and can be grown in nearly every location in Hawaii. Lemon trees are relatively small and widely adapted, typically growing best in sunny locations where temperatures range between 65-90°F.",
        cultivation_tips: "Plant in full sunlight, protected from strong winds, in well-drained soil 15-20 feet from other trees. Soil pH should be 6-7. Apply balanced fertilizer (16-16-16) regularly during growing season, with amounts increasing as tree matures. Water deeply but allow soil to dry slightly between waterings. In Hawaii, trees can be planted year-round but may need winter protection in cooler elevations.",
        pest_management: "Common pests include scale insects, aphids, whitefly, Chinese rose beetle, citrus swallowtail caterpillar, citrus blackfly, and citrus leafminer. Broad mite causes leaf curling. Beneficial insects help control many pests. Foot rot can occur if graft union is too close to ground. Citrus tristeza virus is prevalent in Hawaii but effects can be minimized with proper rootstock selection.",
        pruning_guidelines: "Prune to remove dead branches and limbs that cross over. Remove suckers and shoots from rootstock. Thin interior branches to allow light and air circulation. Best pruning time is just after harvest. Avoid pruning just before flowering as this reduces production. Severe pruning causes vigorous vegetative growth and decreased yield."
    },
    {
        name: "Lime",
   ...
   // THEOBROMA
    ...
    // FRUIT
    {
        ...
        plant_photo: "https://static.wikia.nocookie.net/fruit/images/5/57/Maprang.png/revision/latest?cb=20250110232034",
        emoji: "🥭",
        rare: true,
        general_info: "Maprang (Bouea macrophylla) is a close relative of mango and cashew, native to Southeast Asian tropics including North Sumatra and West Java. This rare tropical fruit tree produces small mango-like fruits with a unique flavor described as a combination of mango and plum with a plum-like texture. The tree grows 25-80 feet tall with light brown, fissured bark and opposite, lanceolate leaves that are 13-45 cm long. Fruits are 2-5 cm diameter drupes that ripen from green to yellow-orange, weighing 57-127 grams each. Commercial production occurs mainly in Thailand, with varieties ranging from very sour to sweet with deep red flesh. Flowers November-December in Thailand, fruits April-May.",
        cultivation_tips: "Maprang thrives in humid, sunlit tropical environments with fertile soil. Plant at 32×40 feet spacing (34 trees/acre) or intensive 17×17 feet spacing (150 trees/acre) with pruning. Propagate by seeds, marcotting (air layering), grafting, or stem cuttings. Grafting speeds fruiting time. Provide shading for first few months after nursery transplant. Seedlings fruit in 7-10 years, grafted plants in 5-6 years. Boost early growth with manure, urea, and fertilizers. Mature trees produce up to 440 pounds fruit per season. Water stress and temperatures below 64°F trigger flowering. Store fruit at 50-55°F (10-13°C) with 85-90% relative humidity for 14-28 days postharvest life.",
        pest_management: "Monitor for scarred-scabbed disease starting as tiny dark spots developing into distorted scarred areas, possibly from thrips (Scirtothrips dorsalis) combined with anthracnose (Colletotrichum gloeosporioides). Penicillium sclerotiorum also associated with scabbed conditions. Soil-borne Fusarium species can infect water-conducting tissue causing tree death. Additional mango pests may affect maprang including lobate lac scale, oriental fruit fly, Mediterranean fruit fly, green scale, red wax scale, white scale, and mango bud mite. Proper identification crucial for effective treatment.",
        pruning_guidelines: "Use pruning to keep trees manageable for ground-level management and harvesting, similar to mango cultivation. Intensive pruning systems allow closer spacing (17×17 feet). Remove dead, diseased, or crossing branches. Prune to maintain pyramidal or cylindrical crown shape. Regular pruning essential for high-density plantings to ensure good light penetration and air circulation throughout the canopy."
    },
    {
        name: "Marang",
        ...
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/RolliniaDeliciosa.jpg/640px-RolliniaDeliciosa.jpg",
        fruit_photo: "https://www.hawaiiantropicalplants.com/PHOTOS/Rollinia_deliciosa.jpg",
        emoji: "🍈",
        rare: true,
        general_info: "Marang (Artocarpus odoratissimus) is a member of the Moraceae family, closely related to jackfruit and breadfruit. Native to Borneo, Palawan, and Mindanao Island, it's an evergreen tree reaching up to 25 meters tall with a trunk diameter up to 50cm. The fruit is highly valued for its sweet, creamy taste that's considered superior to jackfruit. The white segments are easier to eat than jackfruit with no latex, and the fruit has a distinctive strong aroma when ripe.",
        cultivation_tips: "Thrives in humid to very humid tropical lowland climates with annual lows 19-25°C, highs 27-35°C, and 1500-5000mm rainfall with dry season of 3 months or less. Prefers deep, well-drained soil and needs protection from strong winds. Young plants need shade but require increasing light as they mature. Fast-growing tree that needs lots of water. Trees begin bearing fruit at 4-6 years. Harvest fruit while green and let ripen to yellow off tree to prevent damage from falling.",
        pest_management: "Generally hardy but monitor for typical tropical fruit tree pests. Ensure good drainage to prevent root rot in high rainfall areas. The tree is not wind tolerant so provide protection from strong winds. Watch for fungal issues during very humid periods and ensure good air circulation around the tree.",
        pruning_guidelines: "Keep trimmed for easier harvesting as 25-pound fruit falling from 25 feet can be dangerous. Prune to maintain manageable height and strong branch structure. Remove dead or damaged wood promptly. Shape tree when young to develop strong framework. Regular pruning improves air circulation and reduces disease risk in humid tropical conditions."
    },
    {
        ...
        emoji: "🍎",
        rare: true,
        general_info: "Purple Malay Apple (Syzygium malaccense) is a magnificent tropical fruit tree native to Indo-Malaysia, brought to Hawaii as a 'canoe plant' by Polynesian settlers 1000-1700 years ago. Known as 'ōhi'a 'ai in Hawaiian, this culturally significant tree grows 40-60 feet tall with dark glossy opposite leaves and spectacular hot pink flowers that bloom directly from the trunk and branches. The pear-shaped waxy fruits range 2-6 inches long, colored from white to deep red to magenta with crisp, juicy, sweet flesh and a hint of rose flavor. Fast-growing and producing up to 2 crops annually, it's prized for fruit, ornamental beauty, shade, and windbreak purposes.",
        cultivation_tips: "Strictly tropical, damaged by freezing temperatures. Thrives in humid climates with 152cm (60 inches) annual rainfall. Grows from sea level to 2,740m elevation in well-draining soils with constant water supply. Plant in full sun with good air circulation. Propagate by seeds (lose viability quickly), air layering, budding, or cuttings for true-to-type varieties. Seeds germinate by cracking open with roots and shoots emerging from center. Space appropriately for mature 40-60 foot size. Primary requirement is year-round water availability. In Hawaii, grows best in mid-elevation rainforest areas rather than sea level. Usually requires minimal care beyond consistent irrigation.",
        pest_management: "Generally pest-resistant with few serious issues reported. Monitor for scale insects common to Syzygium species. Watch for fruit flies that may attack ripening fruit. Some Syzygium species can become invasive, but S. malaccense is considered low-risk. Birds are often attracted to the fruit, which can be beneficial for natural seed dispersal but may require netting for fruit protection. Maintain good sanitation by removing fallen fruit and debris to prevent fungal issues in humid conditions.",
        pruning_guidelines: "Prune to maintain manageable size for harvesting since trees can reach 60 feet. Remove dead, diseased, or crossing branches. Shape crown to allow light penetration and air circulation. Prune after fruiting to encourage next season's flower production. Since flowers bloom directly from trunk and branches (cauliflory), avoid excessive pruning of main trunk areas. Light annual pruning preferred over heavy pruning. Remove water sprouts and suckers. Time pruning to avoid flowering periods when possible."
    },
    {
        name: "Black Sapote",
        ...
        emoji: "🖤",
        rare: true,
        general_info: "Black Sapote (Diospyros nigra), also known as chocolate pudding fruit or black persimmon, is a tropical fruit tree native to Mexico and Central America. Related to persimmons, it produces medium to large trees (25-80 ft) with distinctive fruit that ripens to a dark brown or black color. The soft, custard-like pulp is often described as having a chocolate pudding-like flavor, earning it the nickname 'chocolate pudding fruit.' The fruit was consumed by indigenous people in Mexico and Central America and later distributed by the Spanish to the Caribbean and Asia.",
        cultivation_tips: "Adapted to tropical and warm subtropical areas from sea level to 6,000 ft elevation. Not cold tolerant - young trees damaged at 30°F, mature trees at 28°F. Plant in full sun, 25-30 feet from buildings and other trees. Grows well in most well-drained soil types including sandy and limestone-based high-pH soils. Flood tolerant but only moderately drought tolerant. Trees are usually dioecious (separate male and female trees). Grafted trees fruit in 2-3 years, seedlings take 5-6 years. Large trees may produce several hundred pounds per year.",
        pest_management: "Generally healthy with few serious pest issues. Monitor for typical tropical fruit tree pests. Ensure good drainage to prevent root rot. Trees can withstand moderate winds if regularly pruned to limit size and open canopy. Select healthy nursery trees and avoid root-bound specimens.",
        pruning_guidelines: "Prune regularly to limit tree size and open canopy to wind movement - this helps trees withstand hurricane-force winds without toppling. Remove dead, diseased, or damaged wood. Shape young trees to develop strong structure. Pruning also improves fruit access and tree management."
    },
    {
        ...
        emoji: "🫐",
        rare: true,
        general_info: "Kwai Muk (Artocarpus hypargyreus), also known as Chinese Mulberry or Monkey Jack, is a rare tropical fruit tree native to southern China, particularly Hong Kong, Fujian, Guangdong, and surrounding regions. Member of the Moraceae family and closely related to jackfruit and breadfruit. It's a slow-growing, slender tree reaching 15-30 feet tall with large, glossy leaves and dense canopy. The small orange-yellow fruits (1-2 inches diameter) have soft, tangy-sweet flesh with flavors reminiscent of apricot, fig, and citrus combined.",
        cultivation_tips: "Thrives in warm tropical and subtropical climates (USDA zones 9-11). Requires full sun (6-8 hours daily) and well-draining, fertile soil with pH 6.0-7.0. More cold hardy than jackfruit - mature trees survive brief exposure to 25-26°F. Self-pollinating and begins fruiting in 3-4 years. Water regularly especially during dry periods but avoid overwatering as roots are prone to rot. Slow-growing initially but productive once established. Can be grown in containers in cooler climates.",
        pest_management: "Generally hardy with few serious pest issues. Monitor for typical tropical fruit pests. Ensure good drainage to prevent root rot during wet periods. Young trees may need protection from frost in marginal climates. Watch for scale insects and aphids occasionally.",
        pruning_guidelines: "Moderate maintenance required including occasional pruning to maintain balanced shape and size. Remove dead or damaged wood. Light pruning helps control size and improves air circulation. Can be shaped as ornamental specimen due to attractive growth habit and glossy foliage."
    },
    {
        ...
        emoji: "🟣",
        rare: true,
        general_info: "Purple Mangosteen (Garcinia mangostana), known as the 'Queen of Fruits,' is a tropical evergreen tree native to Island Southeast Asia. The tree grows 6-25 meters tall with a pyramidal crown and glossy dark green leaves. Fruits have thick purple rinds when ripe, containing sweet, tangy, juicy white flesh segments around seeds. The fragrant edible flesh has fluid-filled vesicles similar to citrus. Trees are extremely slow-growing, taking 8-15+ years to fruit, but can live and produce for over 100 years. Mangosteen is an ultra-tropical plant requiring very specific climate conditions - usually grown within 10 degrees of the equator without dry seasons.",
        cultivation_tips: "Requires warm, humid tropical climate with temperatures 25-35°C (77-95°F) and relative humidity over 80%. Cannot tolerate temperatures below 20°C (68°F) or above 38-40°C (100-104°F). Needs well-draining soil with pH 5-6, tolerating 4.3-7.5. Requires up to 380cm annual rainfall but cannot tolerate waterlogging. Plant in areas sheltered from strong winds and salt spray. Young trees need shade - intercrop with banana, plantain, coconut for protection. Takes minimum 8 years to fruit, often 12+ years. Mature trees can yield 200-3000 fruits per season. Propagation typically by seeds since trees are dioecious (female only in cultivation).",
        pest_management: "Monitor for common tropical tree diseases including leaf spotting fungi like Pestalotiopsis species causing brown leaf spots with yellow halos, especially problematic in Hawaii. Watch for scale insects, aphids, and fruit flies. Root rot can occur in poorly drained soils. Chilling injury symptoms (pericarp hardening, browning of flesh) occur below 12°C storage. Generally pest-resistant but requires good sanitation and air circulation to prevent fungal issues in high humidity.",
        pruning_guidelines: "Minimal pruning required for slow-growing trees. Remove dead, diseased, or crossing branches. Maintain pyramidal crown shape. Prune to improve air circulation and light penetration in humid conditions. Avoid heavy pruning that can stress the slow-growing tree. Focus on structural pruning when young to establish good framework."
    },
    {
        name: "Bacuri (Sour Mangosteen)",
        botanical: "Garcinia acuminata",
        category: "fruit",
        info_url: "https://www.seedsdelmundo.com/product/garcinia-acuminata-bacuri/",
        emoji: "🟡",
        rare: true,
        general_info: "Bacuri (Garcinia acuminata), also known as Bacurizinho, is a tropical fruit tree in the Garcinia family, closely related to mangosteen. Native to the Amazon region and popular in Brazil and South America. The tree grows 20-40 feet tall and produces lemony sweet-sour fruits with wonderfully sweet taste and beautiful yellow, rough-textured skin. An adult tree can yield more than 600 fruits per harvest with potential for 2 harvests per year, and in ideal tropical conditions may fruit year-round.",
        cultivation_tips: "Requires tropical climate (USDA Zone 11) with high humidity and fertile soil with high moisture content. Needs full sun to light shade exposure. Seedlings can begin fruiting when they reach 3 meters (10 feet) in height, typically within 3-6 years. Requires consistent watering and well-draining soil rich in organic matter. Flowering occurs May through August with fruits ripening during late summer in native range.",
        pest_management: "Monitor for typical tropical fruit tree diseases and pests. Ensure good drainage while maintaining soil moisture. Watch for fungal issues during very humid periods. Young trees may need protection from strong winds and intense sun until established.",
        pruning_guidelines: "Minimal pruning required but remove dead or damaged wood. Shape young trees to develop strong framework. Light pruning improves air circulation and fruit access. Can be maintained at manageable height for easier harvesting of the abundant fruit production."
    },
    {
        ...
        emoji: "🟡",
        rare: true,
        general_info: "Mameyito (Garcinia intermedia), commonly known as Lemon Drop Mangosteen or Camias, is a tropical fruit tree native to Central America. This small to medium tree produces smooth spherical fruits about 1 inch in diameter with thin yellow, orange, or red rind surrounding white pulp. The fruits have an appealing sweet and sour taste and are highly valued for their unique flavor profile. Trees may fruit after as little as two years, making them relatively quick producers.",
        cultivation_tips: "Native to Central America and cultivated sporadically throughout the tropics. Prefers tropical climate with consistent warmth and humidity. Requires well-draining soil and regular watering. Plant in full sun to partial shade. Quick to establish and fruit, often producing within 2 years of planting. Relatively small size makes it suitable for home gardens and smaller spaces.",
        pest_management: "Generally hardy tropical fruit tree with few serious pest issues. Monitor for typical Garcinia family pests and diseases. Ensure good drainage to prevent root problems. Watch for scale insects and fruit flies during fruiting season.",
        pruning_guidelines: "Light pruning to maintain shape and size. Remove dead or damaged branches. Can be kept compact for easier fruit harvesting. Regular pruning improves air circulation and reduces disease pressure in humid climates."
    },
    {
        ...
        emoji: "🟠",
        rare: true,
        general_info: "Achachairu (Garcinia humilis), also known as Orange Mangosteen or Bolivian Mangosteen, is a small pyramidal-canopy tree native to the Amazon basin in Bolivia. The name 'Achachairu' means 'honey kiss' in the Guarani language. It's a prolific fruiting tree related to mangosteen, producing bright orange egg-shaped fruits with tangy-refreshing flavor - a fine balance between sweetness and acidity. The tree grows 10-20 feet tall with glossy leaves that are darker green on top and lighter underneath.",
        cultivation_tips: "Native to medium-altitude rainforests, grows well in shady, humid climates (USDA zones 10-13). Requires soil with good porosity and consistent moisture. Slow-growing initially but eventually fruits abundantly. Trees typically start bearing fruit after 6 years. Fruit should be picked mature as it does not ripen further after storage. Can be grown in containers with proper care. Prefers warm tropical and subtropical climates with protection from frost.",
        pest_management: "Generally hardy but monitor for typical tropical fruit tree pests and diseases. Ensure good air circulation in humid conditions. Watch for scale insects and fungal issues during wet periods. Young trees may need protection from strong winds.",
        pruning_guidelines: "Light pruning to maintain pyramidal shape and manageable size. Remove dead, diseased, or crossing branches. Prune to improve air circulation and light penetration. Regular pruning helps maintain the attractive ornamental appearance while improving fruit production and access."
    },
    {
    ...
    },
    {
        ...
        flower_photo: "https://wildlifeofhawaii.com/images/flowers/Psidium-guajava-3.jpg",
    ...
    },
    {
        ...
        category: "fruit",
        plant_photo: "https://wildlifeofhawaii.com/images/flowers/Cocos-nucifera-1.jpg",
    ...
    },
    {
        ...
        flower_photo: "https://wildlifeofhawaii.com/images/flowers/Mangifera-indica-3.jpg",
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        general_info: "Vanilla planifolia is a climbing orchid vine native to Mexico that produces the vanilla beans used for flavoring. In Hawaii, this labor-intensive crop requires hand pollination since natural pollinators are absent. The vine grows up trees or support structures using aerial roots, producing white flowers that open at 6 AM and close by early afternoon. Only flowers pollinated within 36 hours will develop into vanilla beans. Hawaii's warm temperatures, ample rainfall, and fertile volcanic soil create excellent growing conditions. The beans have fragrance notes of honey and chocolate, with a floral, complex, and naturally sweet base flavor profile that secures Hawaiian vanilla's place at the top of connoisseurs' lists.",
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        general_info: "Cardamom is a 5-10 foot tall herbaceous perennial in the ginger family, native to India, Sri Lanka, and Burma. Called the 'Queen of Spices' and third most expensive spice after saffron and vanilla. Forest-dwelling plant with rigid erect stems and leaves up to 2 feet long. Flowers emerge from plant base as white blooms with lilac-purple veins. Produces 3/4-inch green pods containing 15-20 aromatic black seeds. Introduced to Hawaii in 1885 with 6 plants from Jamaica.",
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        general_info: "Ceylon cinnamon is an evergreen tree native to Sri Lanka, growing 10-15 meters tall. Also called 'true cinnamon' to distinguish from cassia. Inner bark is source of prized cinnamon spice with delicate, sweet flavor. Forms multiple stems from base that are harvested in rotation. Leaves are aromatic and can be used for tea. Produces small white flowers and dark blue berries. Much more expensive than common cassia cinnamon.",
        cultivation_tips: "Requires tropical climate with high humidity and well-distributed rainfall. Grows best in rich, well-draining sandy loam soil. Prefers partial shade, especially when young. Sensitive to drought and frost. In Hawaii, grows well at higher elevations with cooler temperatures. Plant in protected location away from strong winds. Needs consistent moisture but good drainage.",
        pest_management: "Generally resistant to pests when grown in suitable conditions. May be affected by scale insects and aphids. Fungal diseases possible in overly wet conditions. Monitor for bark borers which can damage stems. Root rot in poorly drained soils. Proper spacing and pruning help prevent disease issues.",
        pruning_guidelines: "Coppice system used for bark production - cut stems to ground level every 2-3 years to promote new shoot growth. For ornamental use, prune lightly to maintain shape. Remove dead, damaged, or crossing branches. Harvest bark from 2-3 year old shoots by cutting and peeling. Allow multiple stems to develop from base for continuous harvest rotation."
    },
    {
        name: "Lemongrass",
