   ...
   // THEOBROMA
    {
        ...
        general_info: "Criollo x Steve Cacao is a rare hybrid variety of *Theobroma cacao*, crossing traditional Criollo genetics with modern cultivars. **Mature Size**: Grows 15-25 feet (4.5-7.5 meters) tall with trunk diameter of 8-12 inches and canopy spread of 12-20 feet. **Growth Habit**: Small to medium evergreen tree with large, drooping leaves and cauliflorous flowers/pods growing directly from trunk and branches. **Quality**: Criollo known as 'Aristocrat of Cacao' for delicate, complex flavors with floral and fruity notes. **Rarity**: Represents less than 1% of global chocolate production due to disease susceptibility and lower yields. **Value**: Highly prized among chocolate connoisseurs and bean-to-bar producers for exceptional flavor profile.",
        cultivation_tips: "**Climate**: Requires tropical climate within 20 degrees north/south of equator. **Soil**: Rich, well-drained soils with consistent moisture but not waterlogged. **Light**: Grows best with light shade protection - plant as understory crop under shade trees like banana or coconut. **Temperature**: Optimal range 70-85°F (21-29°C) with high humidity. **Production**: Grafted trees begin fruiting in 4-5 years. **Hawaii-specific**: Thrives in windward areas with consistent rainfall and humidity. **Protection**: Shield from strong winds which damage large leaves and developing pods. **Spacing**: Plant 12-15 feet apart in agroforestry systems.",
        pest_management: "**Disease susceptibility**: Highly susceptible to fungal diseases in wet conditions. **Major diseases**: Phytophthora pod rot, black pod disease, frosty pod rot, witches' broom disease. **Pests**: Scale insects and aphids problematic. **Prevention**: Ensure excellent air circulation and avoid overhead watering. **Sanitation**: Remove infected pods promptly to prevent disease spread. **Hawaii-specific**: Monitor closely during wet seasons. **Cultural practices**: Proper spacing and pruning essential for disease prevention.",
        pruning_guidelines: "**Height management**: Prune to maintain 20 feet (6 meters) height for easier harvesting and disease management. **Canopy structure**: Create open structure for light penetration and air circulation - critical for disease prevention. **Regular maintenance**: Remove suckers and water sprouts regularly. **Timing**: Prune during dry season to reduce disease risk. **Framework**: Shape tree with 3-4 main scaffold branches. **Sanitation**: Remove dead or diseased wood promptly to prevent pathogen spread."
    },
    {
    ...
    },
    {
        ...
        emoji: "🔴",
        rare: true,
        general_info: "Fingersop (*Meiogyne cylindrocarpa*), also known as Red Paipai, is a rare tropical fruit tree in the Annonaceae family (custard apple family). **Mature Size**: Small to medium tree reaching 15-25 feet (4.5-7.5 meters) tall with trunk diameter of 6-10 inches. **Growth Habit**: Evergreen tree with simple, alternate leaves and distinctive finger-like cylindrical fruits. **Distribution**: Native to Southeast Asia including Indonesia, Malaysia, and Philippines. **Conservation status**: Listed as Least Concern by IUCN. **Family relations**: Related to soursop, cherimoya, and sugar apple but represents much less common genus. **Rarity**: Limited cultivation outside native range due to specialized requirements and lack of commercial development.",
        cultivation_tips: "**Climate**: Requires tropical climate with high humidity and consistent warmth year-round. **Soil**: Well-draining, fertile soil rich in organic matter essential. **Light**: Benefits from partial shade during establishment, especially protection from harsh direct sunlight when young. **Protection**: Needs shelter from strong winds which can damage leaves and developing fruits. **Hawaii-specific**: May perform well in protected windward locations with consistent moisture. **Spacing**: Plant 15-20 feet apart to accommodate mature size. **Establishment**: Slow initial growth typical of Annonaceae family. **Rarity**: Limited cultivation information available due to uncommon status in commercial agriculture.",
        pest_management: "**Family susceptibility**: Monitor for typical Annonaceae family pests including scale insects and mealybugs. **Fungal diseases**: Watch for fungal issues common in humid tropical conditions - ensure excellent air circulation. **Root health**: Avoid waterlogged conditions which can cause root rot. **Hawaii-specific**: Limited specific pest information due to rare cultivation - follow general tropical fruit tree monitoring. **Prevention**: Good sanitation and proper spacing help prevent disease issues. **Caution**: Handle with care as rare species may be more sensitive to stress.",
        pruning_guidelines: "**Conservative approach**: Minimal pruning recommended due to limited cultivation experience and potential sensitivity. **Basic maintenance**: Remove dead, diseased, or damaged wood carefully. **Shape training**: Light pruning to improve structure and air circulation. **Timing**: Prune during dry periods to reduce disease risk. **Sensitivity**: Annonaceae family trees can be sensitive to heavy pruning - use light, gradual approach. **Observation**: Monitor tree response to any pruning and adjust techniques accordingly."
    },
    {
        ...
        emoji: "🍐",
        rare: true,
        general_info: "Biriba (*Annona mucosa*), also known as Wild Sweetsop, Lemon Meringue Pie Fruit, or Biribá, is a fast-growing tropical tree in the Annonaceae family native to tropical South America. **Mature Size**: Reaches 13-50 feet (4-15 meters) tall with trunk diameter of 8-15 inches and spreading canopy. **Growth Habit**: Fast-growing, flood-tolerant tree with large, simple leaves. **Fruit**: Large conical or round fruits ripen from green to yellow with soft spines that bruise easily. **Flavor**: Fruit pulp remarkably sweet, tasting like lemon meringue pie. **Production**: Can bear fruit from seed within 3 years - exceptionally fast for Annonaceae family. **Challenge**: Delicate nature and short shelf life (less than a week) limit commercial potential but make it prized for home gardens.",
        cultivation_tips: "**Growth rate**: Fast-growing with exceptional flood tolerance among fruit trees. **Climate**: Requires temperatures above 59°F (15°C) year-round in hot, humid tropical conditions. **Light**: Sun-loving - plant in full sun for best production. **Soil**: Well-draining but moisture-retentive soil essential. **Water**: Thrives with abundant rainfall and consistent moisture. **Pollination**: Self-fertile but benefits from cross-pollination for better fruit set. **Propagation**: Usually grown from seeds which remain viable 2 years when kept dry and dark. **Grafting**: Can be grafted onto *Annona montana* or *A. glabra* rootstock for dwarfing. **Hawaii-specific**: Excellent for wet windward locations with consistent rainfall.",
        pest_management: "**Disease resistance**: Generally hardy with good natural resistance. **Family pests**: Monitor for typical Annonaceae pests including scale insects and fruit flies. **Fruit protection**: Soft, delicate fruits easily damaged - protect from physical damage and harvest carefully when fully ripe. **Shelf life**: Very short shelf life (less than a week) requires immediate consumption or processing. **Hawaii-specific**: Watch for fruit flies during ripening season. **Handling**: Gentle handling essential due to fruit's delicate nature.",
        pruning_guidelines: "**Maintenance**: Light pruning to maintain shape and manageable size for easier fruit harvesting. **Structure**: Remove dead or damaged wood and shape young trees to develop strong framework. **Production**: Avoid over-pruning as this can significantly reduce fruit production. **Air circulation**: Regular light pruning improves airflow and fruit access while maintaining natural growth habit. **Timing**: Prune during dry season in Hawaii to reduce disease risk. **Fast growth**: May require more frequent pruning due to vigorous growth rate."
    },
    {
    ...
    },
    {
        ...
        emoji: "🍈",
        rare: true,
        general_info: "Babaco (*Carica pentagona*), also known as Mountain Papaya, is a naturally occurring hybrid of *Carica stipulata* and *C. pubescens* from Ecuador's central south highlands. **Mature Size**: Small herbaceous shrub growing to 6 feet (1.8 meters) tall with trunk diameter of 3-4 inches. **Growth Habit**: Erect softwood trunk lined with distinctive leaf scars, similar to papaya but much smaller. **Fruit**: Distinctly five-sided fruits reaching 12 inches long and 8 inches wide, setting parthenocarpically (seedless). **Flavor**: Very juicy flesh, slightly acidic and low in sugar with unique flavors combining strawberry, pineapple, and papaya overtones. **Edible skin**: Smooth, thin skin is completely edible. **Origin**: Presumed natural hybrid from Ecuadorian highlands.",
        cultivation_tips: "**Climate**: Thrives in cool subtropical climate, free of frost but tolerates temperatures to 28°F (-2°C) though may lose leaves. **Soil**: Light, fertile, well-drained soil essential with adequate rainfall or irrigation during growing phase. **Fertilizer**: Feed monthly with nitrogen fertilizers during growing season - composted chicken manure makes excellent mulch. **Container growing**: Ideally suited to container culture and excellent for greenhouse cultivation. **Location**: Plant in warm location protected from winds - sunny spot preferred but tolerates shade. **Hawaii-specific**: May perform well at higher elevations (1,000-3,000 feet) where temperatures are cooler.",
        pest_management: "**Disease prevention**: Start with virus-free material essential. **Fungal diseases**: During moist spells, monitor for powdery mildew and Phytophthora root rot affecting leaves. **Major pests**: Two-spotted mite (*Tetranychus urticae*) and strawberry mite (*T. atlanticus*) problematic. **Control challenges**: Most miticides phytotoxic to babaco leaves - predatory mites provide reasonable biological control. **Other pests**: Slugs and snails can damage fruit. **Wildlife**: Plants attractive to deer who consume foliage and young fruits - protection may be needed.",
        pruning_guidelines: "**Single trunk system**: For maximum fruit quality and size, allow only one trunk to grow. **Sucker removal**: Remove shoots forming around base, but allow second shoot to develop from September. **Height control**: Don't crop one trunk for more than 1-2 years to control height. **Renewal pruning**: Cut trunk that bore current season fruits back to stump where second shoot was left. **Succession**: Second shoot becomes the new productive plant, ensuring continuous production cycle."
    },
    {
        ...
        emoji: "🟢",
        rare: true,
        general_info: "Spanish Lime (*Melicoccus bijugatus*), also known as Mamoncillo, Genip, or Quenepa, is a slow-growing tree native to northern South America and Island of Margarita. **Mature Size**: Reaches up to 85 feet (26 meters) tall with round or oval canopy and trunk diameter of 2-3 feet. **Growth Habit**: Medium to large tree with alternate compound leaves having 4 opposite elliptic leaflets 2-5 inches long. **Fruit**: Drupes borne in loose clusters, 0.3-0.8 oz each with 40-59% pulp. Green, thin but leathery brittle skin covers glistening translucent, pinkish to yellowish aril (pulp). **Flavor**: Sweet (18.5-26% total soluble solids) with acidic overtones, rich in iron and phosphorus. **Pollination**: Dioecious - requires both male and female trees for fruit production. **Varieties**: 'Large', 'Jose Pabon', and 'Montgomery' available.",
        cultivation_tips: "**Climate**: Well-adapted to tropical and warm subtropical areas. **Cold tolerance**: Not freeze tolerant - young trees damaged/killed below 32°F (0°C), mature trees damaged at 27-28°F (-2.8 to -2.2°C). **Soil**: Prefers well-drained soil but grows in nutritionally poor soil. **pH tolerance**: Tolerates very alkaline and saline soils, thrives in limestone soil with pH 8.2. **Water**: Tolerant of prolonged drought but intolerant of flooding. **Light**: Plant in full sun to semi-shade. **Production**: Takes 8-10 years from seed to fruit production. **Fertilizer**: Regular feeding with balanced fertilizer during growing season beneficial. **Hawaii-specific**: Excellent for leeward areas with alkaline soils.",
        pest_management: "**Disease resistance**: Relatively pest-free when established. **Young tree issues**: Young trees may be susceptible to scale insects. **Regional pests**: In some areas, problems with aphids, spider mites, and nematodes reported. **Fruit protection**: Fruit flies can be issue during fruiting season - use male fruit fly traps for control. **Wind damage**: Strong winds can damage branches - windbreaks recommended in exposed locations. **Hawaii-specific**: Monitor for typical tropical fruit tree pests during establishment phase.",
        pruning_guidelines: "**Maintenance**: Minimal pruning required once established due to naturally good structure. **Basic care**: Remove dead, damaged, or crossing branches during dormant season. **Size control**: Can be pruned to maintain desired size and shape for easier harvesting. **Training**: Young trees benefit from training to develop strong scaffold branches. **Production**: Avoid heavy pruning as it can significantly reduce fruit production. **Timing**: Prune during dry season in Hawaii to reduce disease risk."
    },
    {
        name: "Tamarind",
        ...
        emoji: "🟤",
        rare: false,
        general_info: "Tamarind (*Tamarindus indica*) is a handsome introduced shade tree native to tropical Africa, widely cultivated in tropical regions. **Mature Size**: Medium-sized evergreen tree reaching 40-80 feet (12-25 meters) tall with rounded crown of dense foliage and trunk diameter of 2-4 feet. **Growth Habit**: Blue-green feathery pinnate leaves with 10-18 pairs of leaflets. **Flowers**: Showy pale yellow flowers tinged with red in terminal racemes. **Fruit**: Thick brown pods 3-8 inches long containing sour edible pulp surrounding 1-10 seeds. **Wood**: Very hard, heavy wood that takes fine polish, strong and durable though susceptible to dry-wood termites. **Historical**: Introduced to Hawaii in 1797 by Don Marin.",
        cultivation_tips: "**Propagation**: Easily propagated from seed with high germination rates. **Soil**: Grows in variety of soil conditions, particularly well-adapted to dry areas where it often escapes cultivation. **Climate**: Tolerates drought conditions exceptionally well once established. **Light**: Prefers full sun exposure for optimal growth and fruiting. **Drainage**: Requires well-drained soils but tolerates various soil types. **Salt tolerance**: Can withstand some salt spray in coastal locations. **Hawaii-specific**: Thrives in leeward areas and planted mainly for shade along roadsides in dry regions. **Spacing**: Plant 30-40 feet apart to accommodate mature canopy spread.",
        pest_management: "**Disease resistance**: Generally pest-resistant when established with few serious problems. **Wood pests**: May be susceptible to dry-wood termites which can damage the valuable wood. **Minor pests**: Monitor for scale insects and aphids on young growth. **Hawaii-specific**: Relatively few pest problems reported in Hawaiian conditions. **Wind damage**: Strong winds can cause branch breakage due to somewhat brittle wood - provide windbreaks in exposed locations. **Maintenance**: Good sanitation helps prevent pest establishment.",
        pruning_guidelines: "**Maintenance**: Requires minimal pruning once established due to naturally good structure. **Basic care**: Remove dead, damaged, or crossing branches to maintain tree health. **Shape control**: Can be pruned to maintain desired shape and size for specific landscape uses. **Timing**: Prune after fruit harvest to maintain tree structure and prepare for next season. **Caution**: Avoid heavy pruning as pod litter can be objectionable in street plantings. **Urban use**: Light pruning helps manage size for urban environments while maintaining shade value."
    },
    {
        ...
        emoji: "🍐",
        rare: false,
        general_info: "Guanábana (*Annona muricata*), also known as Soursop, is a tropical evergreen tree producing the largest fruit in the Annonaceae family. **Mature Size**: Small tree reaching 15-30 feet (4.5-9 meters) tall with trunk diameter of 8-12 inches. **Growth Habit**: Low branching and bushy with upturned limbs and large, simple leaves. **Fruit**: Heart-shaped to oval fruits range from few inches to over 1 foot in length, weighing up to 15 pounds. **Flavor**: White fruit segments have pleasant sub-acid flavor, most seedless though fertile ones have smooth black seeds. **Caution**: Seeds and bark contain toxic compounds including potentially poisonous alkaloids. **Family**: Member of custard apple family (Annonaceae).",
        cultivation_tips: "**Drought tolerance**: Most drought-tolerant of the annonas, excellent for dry areas. **Soil**: Prefers well-drained soils but tolerates wide range of volcanic soils. **Spacing**: Plant 8x8 ft to 20x25 ft spacing for average 100 trees per acre. **Fertilization**: Quarterly fertilization with 10-10-10 NPK: ½ pound first year, 1 pound second year, 3 pounds thereafter. **Protection**: Requires protection from frost and strong winds. **Root system**: Shallow root system benefits from copious mulching. **Climate**: High temperatures (80-90°F) and low humidity (30%) cause pollination problems; prefers 70s with 80% humidity. **Hawaii-specific**: Well-suited to protected areas with consistent moisture.",
        pest_management: "**Diseases in Hawaii**: Anthracnose (*Colletotrichum gloeosporioides*), bacterial wilt (*Pseudomonas* spp.), black canker (*Phomopsis anonacearum*), diplodia rot (*Botryodiplodia* spp.), and corky rot (*Cylindrocladium colhounii*). **Insect pests**: Cerconota moth, leaf miner, seed borer, caterpillars, scale insects, Oriental fruit fly, melon fly, and Mediterranean fruit fly. **Management**: Regular monitoring and integrated pest management approach essential. **Fruit protection**: Harvest timing critical to avoid fruit fly infestation.",
        pruning_guidelines: "**Maintenance**: Once shaped, requires little pruning other than cutting out dead or poorly placed branches after harvest. **Size control**: Trees can be topped at about 6 feet to cause fruit production on lateral branches and facilitate harvesting. **Form**: Minimal pruning maintains natural form while improving air circulation. **Timing**: Prune after harvest to prepare for next growing season. **Training**: Young trees benefit from early shaping to develop strong structure."
    },
    {
        name: "Guava",
        ...
        emoji: "🍐",
        rare: false,
        general_info: "Common Guava (*Psidium guajava*) is a tropical evergreen tree/shrub producing sweet, floral-flavored fruits extremely rich in vitamin C (more than oranges). **Mature Size**: Small to medium tree reaching 10-33 feet (3-10 meters) tall with trunk diameter of 6-12 inches. **Growth Habit**: Fast-growing especially during warm months, can be shrub-like or tree form. **Fruit**: Round to oval fruits with sweet, aromatic flesh. **Hawaiian varieties**: Often have pink flesh and robust, slightly tart flavor ideal for jams and jellies. **Seasonal behavior**: In winter, leaves turn purple/red and growth stops. **Invasive potential**: Can be invasive in some tropical regions due to aggressive spreading and bird-dispersed seeds.",
        cultivation_tips: "**Soil**: Thrives in any soil with good drainage, very adaptable to various soil types. **Light**: Full sun for best flowering and fruit production. **Climate**: Requires cold protection, not suitable outdoors in most US zones except Hawaii, Virgin Islands, Florida, and sheltered areas in California/Texas. **Fertilization**: Fertilize every 1-2 months while young, then 3-4 times per year as tree matures. **Nutrients**: Needs high nitrogen, phosphoric acid, potash, plus magnesium. **Formula example**: 6-6-6-2 worked into soil before growing season. **Hawaii-specific**: Thrives in most Hawaiian conditions from sea level to moderate elevations.",
        pest_management: "**Disease resistance**: Relatively hardy with good natural resistance. **Fruit flies**: Susceptible to fruit flies - use male fruit fly traps for control. **Scale insects**: Can affect young growth - monitor and treat as needed. **Environmental stress**: In coastal areas, salt winds can burn leaves but tree recovers with new growth. **Other pests**: Monitor for aphids and spider mites. **Harvest timing**: Fruit should be picked when just changing from green to light yellow to avoid fruit fly larvae infestation.",
        pruning_guidelines: "**Flexibility**: Responds very well to pruning to keep compact and manageable. **Container growing**: Can be kept small for container growing or even pruned as bonsai. **Maintenance**: Regular pruning helps maintain desired shape and improves air circulation. **Timing**: Prune after fruiting season for best results. **Basic care**: Remove dead, damaged, or crossing branches. **Training**: Can be trained as single or multi-trunk specimens depending on desired form."
    },
    {
        name: "Coconut",
        ...
        emoji: "🥥",
        rare: false,
        general_info: "Coconut (*Cocos nucifera*) is a large palm native to the Central Indo-Pacific region, carried by Polynesians to Hawaii. **Mature Size**: Grows up to 100 feet (30 meters) tall with trunk diameter of 1-2 feet. **Growth Habit**: Single trunk topped with crown of pinnate leaves 13-20 feet (4-6m) long. **Production**: On fertile soil, can yield up to 75 fruits per year. **Timeline**: Produces first fruit in 6-10 years, reaching peak production after 15-20 years. **Distribution**: Nearly cosmopolitan due to human cultivation and natural oceanic dispersal. **Uses**: Symbol of tropics, excellent for preventing beach erosion, provides food, water, fiber, and building materials.",
        cultivation_tips: "**Light**: Requires direct sun for optimal growth and fruit production. **Temperature**: Warm temperatures essential (minimum 64°F for fruit production). **Humidity**: High humidity preferred. **Soil**: Thrives in well-drained, fertile soil but remarkably tolerates sandy, poor soils and salt spray. **Water**: Needs continuous water supply to keep soil moist but cannot tolerate waterlogging. **Planting**: Plant in spring, transplant during warmest, rainiest months. **Irrigation**: Provide inch of water weekly after planting. **Mulching**: Apply mulch to retain moisture and suppress weeds. **Hawaii-specific**: Thrives in coastal areas with natural salt tolerance.",
        pest_management: "**Major disease**: Susceptible to lethal yellowing disease spread by leafhoppers - choose resistant varieties like 'Maypan'. **Other pests**: Palm leaf skeletonizer, aphids, nematodes, spider mites, scale, and coconut leaf beetle (*Brontispa longissima*). **Regional concerns**: In Florida, thousands killed by lethal yellowing disease. **Global monitoring**: Watch for yellowing diseases affecting coconut plantations worldwide. **Hawaii-specific**: Generally fewer pest problems in Hawaiian conditions but monitor for introduced pests.",
        pruning_guidelines: "**Minimal pruning**: Requires very little pruning intervention. **Dead frond removal**: Only remove completely brown, dead fronds - never remove yellowing fronds as they provide essential nutrients to tree. **Avoid over-pruning**: Avoid 'hurricane cuts' or removing green fronds which severely weakens the palm. **Proper technique**: Maintain 6-8 green fronds above newest emerging frond. **Health impact**: Improper pruning weakens tree and makes it highly susceptible to pests and diseases."
    },
    {
        name: "Papaya",
        ...
        emoji: "🧡",
        rare: false,
        general_info: "Papaya (*Carica papaya*) is a herbaceous perennial plant with a hollow trunk native to lowland tropical Central and South America. **Mature Size**: Reaches up to 20 feet (6 meters) tall with trunk diameter of 6-8 inches, crowned with large palmate leaves. **Historical**: Cultivated in Hawaii since early 1800s. **Varieties**: Solo varieties are small enough for one person (1-3 pounds) with either red or yellow flesh. **Sex types**: Trees are dioecious with female and hermaphrodite plants; hermaphrodite preferred commercially for pear-shaped fruits. **Production**: Matures in 6-9 months in warmer regions, 9-11 months in cooler areas. **Yield**: Can produce up to 100 fruits per growing season under optimal conditions.",
        cultivation_tips: "**Elevation**: Grows best below 500 ft elevation in warm areas with 40-60 inches annual rainfall. **Requirements**: Full sun, well-drained soil, and protection from winds exceeding 40 mph essential. **Spacing**: Plant 4-5 feet apart in rows 15-20 feet apart for commercial production. **Temperature**: Commercial production limited to minimum temperatures above 60°F (15°C). **Fertilization**: Fertilize every 2 weeks (ground trees) or 10 days (potted plants) with phosphorus-dominant fertilizer. **Drainage**: Critical - waterlogging can kill plants in hours. **Limitations**: Salt spray and saline soils are detrimental. **Hawaii-specific**: Thrives in protected leeward locations with good drainage.",
        pest_management: "**Major disease**: Papaya Ringspot Virus (PRV) - use genetically resistant cultivars like 'Rainbow' and 'UH SunUp'. **Fungal control**: Preventative mancozeb applications every 2-3 weeks in high rainfall areas. **Insect pests**: Stevens leafhopper, white peach scale, fruit flies (Mediterranean, Oriental, Melon), mealybugs, and various mites. **Other pests**: Slugs damage fruit and must be controlled. **Export requirements**: Use approved disinfestation treatments for export fruit. **Hawaii-specific**: PRV resistance critical for successful cultivation.",
        pruning_guidelines: "**Single trunk system**: Allow only one main trunk for best fruit quality and size. **Sucker management**: Remove shoots around base except for one replacement shoot in September. **Renewal pruning**: Cut fruited trunk back to stump after harvest, allowing replacement shoot to become new main plant. **Caution**: Avoid cutting hollow trunk as water entry causes rot. **Leaf management**: Trim leaves only when petioles rub against fruits or interfere with spraying operations."
    },
    {
        name: "Mulberry",
        botanical: "Morus",
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        general_info: "Vanilla (*Vanilla planifolia*) is a climbing orchid vine native to Mexico and Central America, the primary source of natural vanilla flavor. **Mature Size**: Vines can reach 50-100 feet (15-30 meters) in length when climbing trees, with stems 0.5-1 inch diameter. **Growth Habit**: Epiphytic climbing vine using aerial roots to adhere to support structures. **Cultural significance**: Name derives from Spanish 'vainilla' meaning 'little pod.' **Production challenge**: Requires hand pollination in Hawaii since natural pollinators (euglossine bees) absent. **Flowering**: Greenish-white flowers open at 6 AM, close by early afternoon - only 36-hour pollination window. **Quality**: Hawaiian vanilla has honey and chocolate fragrance notes with floral, complex, naturally sweet profile securing top connoisseur status. **Timeline**: Takes 2-4 years to mature, beans develop 5 months after pollination.",
        cultivation_tips: "**Light**: Partial shade with 50% sun exposure essential - protect from strong winds. **Soil**: Rich, well-draining soil with high organic content and consistent moisture. **Support**: Provide bamboo trellises or living trees - prefers growing on living trees with bark for root adherence. **pH**: Maintain soil pH 6.0-7.0 for optimal growth. **Fertilizer**: Apply balanced NPK during growth and fruit development. **Hawaii-specific**: Warm temperatures, ample rainfall, and fertile volcanic soil create excellent conditions. **Hand pollination**: Required in Hawaii - flowers open around 6 AM for only few hours. **Processing**: Beans require careful curing process involving blanching and drying to 30-35% moisture content. **Spacing**: Allow adequate space for mature vine size.",
        pest_management: "**Disease resistance**: Generally robust with few major pest issues in Hawaii. **Common pests**: Monitor for scale insects, aphids, and spider mites common to orchids. **Fungal prevention**: Ensure excellent air circulation to prevent fungal issues in humid conditions. **Root health**: Root rot possible with poor drainage or overwatering. **Advantages**: Strong aerial root system helps prevent mechanical damage. **Sanitation**: Regular inspection and removal of dead or diseased plant material prevents disease spread. **Hawaii-specific**: Generally pest-free but monitor during wet seasons.",
        pruning_guidelines: "**Training**: Train vines on support structures to manageable heights for hand pollination and harvesting accessibility. **Maintenance**: Remove dead, diseased, or excess vegetative growth regularly. **Air circulation**: Prune to maintain good airflow and light penetration. **Flower production**: Since flowers emerge from vine nodes, avoid excessive pruning of mature vine sections. **Establishment**: Allow vines to establish on support before heavy pruning. **Technique**: Regular light pruning preferred over heavy annual cuts. **Timing**: Prune after harvest season in Hawaii to prepare for next flowering cycle."
    },
    {
        ...
        emoji: "🌿",
        rare: false,
        general_info: "Horseradish Tree (*Moringa oleifera*) is a fast-growing, drought-resistant deciduous tree known as the 'miracle tree' or 'Tree of Life' for its exceptional nutritional value. **Mature Size**: Reaches 33-40 feet (10-12 meters) tall with trunk diameter of 8-12 inches and white-gray corky bark. **Growth Rate**: Can grow up to 8 feet per year with amazing resilience to regrow when cut. **Management**: Trees regularly cut to knee-chest height for easier harvesting. **Flowers**: Produces fragrant cream-white flowers in panicles. **Pods**: Long seed pods (drumsticks) are edible when young. **Cultural use**: Common in Hawaiian Filipino communities for culinary and medicinal purposes. **Nutrition**: Leaves extremely rich in vitamins A, C, calcium, iron, and protein.",
        cultivation_tips: "**Soil**: Grows best in neutral to slightly acidic soil (pH 6.3-7.0), well-drained sandy or loamy soil essential. **Climate**: Sun and heat-loving plant that does not tolerate freezing or frost. **Drought adaptation**: Particularly suitable for dry regions - can be grown using rainwater without expensive irrigation. **Temperature**: Prefers 77-95°F (25-35°C), tolerates up to 118°F (48°C) with afternoon shade. **Water**: Water daily while young, becomes drought-tolerant when established. **Fertilization**: Apply controlled-release fertilizer twice yearly in late winter and late summer. **Hawaii-specific**: Thrives in leeward areas and excellent for sustainable food production.",
        pest_management: "**Disease resistance**: Not affected by serious diseases under proper conditions. **Common pests**: May be attacked by aphids, caterpillars, and fruit flies in warm climates. **Control**: Use pyrethrum-based insecticides for aphids and caterpillars. **Root problems**: In waterlogged soil, roots have tendency to rot - ensure excellent drainage. **Establishment**: Generally pest-free once established. **Wildlife**: Birds may eat seeds and spread plants naturally. **Hawaii-specific**: Very few pest problems in Hawaiian conditions.",
        pruning_guidelines: "**Essential practice**: Regular pruning essential to prevent tree becoming too tall and increase harvest yield. **Timing**: Prune during dormant season before new growth starts. **Young tree training**: When 30-36 inches tall, cut back to 18-24 inches leaving 4-5 branches in vase form. **Height management**: When branches reach 8-10 feet, top to eye level for easier harvesting. **Maintenance**: Remove shoots growing straight up and crossing/dead branches. **Harvest pruning**: Cut regularly between knee and chest height for continuous leaf production and easier harvesting."
    },
    {
        name: "Cardamom",
    ...
    },
    {
        ...
        emoji: "🍇",
        rare: true,
        general_info: "Jabuticaba (*Plinia cauliflora*), also known as Brazilian Grape Tree, is a unique tropical fruit tree native to Brazil. **Mature Size**: Slow-growing evergreen that can reach 15 meters (49 ft) if not pruned. **Unique Feature**: Exhibits cauliflory - fruits grow directly on the trunk and branches, making it visually striking. **Fruit**: Round, purplish-black fruits 3-4 cm in diameter with white or rosy pink gelatinous flesh. **Flavor**: Sweet, grape-like taste with astringent skin. **Production**: May flower and fruit 5-6 times per year in native habitat. **Cultural significance**: Name derives from Tupi word meaning 'place where tortoises are found' or 'like turtle fat' referring to white pulp. **Commercial use**: Eaten fresh or made into jellies, jams, juice, or wine.",
        cultivation_tips: "**Climate**: Tropical to subtropical, tolerates mild frosts down to -3°C (26°F). **Soil**: Prefers moist, rich, lightly acidic soil but adaptable to alkaline beach-sand soils with irrigation. **Light**: Full sun to partial shade. **Hawaii-specific**: Well-suited to Hawaii's climate, excellent for container growing due to compact fibrous root system. **Water**: Requires consistent moisture, drought tolerant but fruit production reduced. **Spacing**: Compact root system makes it suitable for pots or close planting. **Production timeline**: Grafted plants fruit in 5 years, seed-grown trees take 10-20 years. **Container growing**: Excellent choice for large containers due to fibrous root system.",
        pest_management: "**Disease susceptibility**: Vulnerable to rust (*Austropuccinia psidii*) especially during flowering in heavy rain. **Common diseases**: Canker (*Colletotrichum gloeosporioides*), dieback (*Rosellinia*), and fruit rot (*Botrytis cinerea*). **Hawaii-specific**: Monitor for introduced tropical fruit pests. **Environmental**: Intolerant of salty soils or salt spray. **Preventive care**: Ensure good air circulation during wet periods, avoid overhead watering during flowering. **Maintenance**: Regular inspection for fungal issues in humid conditions.",
        pruning_guidelines: "**Shape maintenance**: Regular pruning to maintain manageable size and attractive form. **Structure**: Remove dead, diseased, or crossing branches. **Size control**: Can be kept smaller through pruning, excellent for bonsai cultivation. **Air circulation**: Prune to improve airflow and reduce disease risk. **Timing**: Prune after fruiting periods. **Ornamental value**: Pruning enhances the unique trunk-fruiting display. **Container plants**: Regular pruning essential for pot-grown specimens."
    },
    {
        ...
        emoji: "⭐",
        rare: true,
        general_info: "Star Apple (*Chrysophyllum cainito*) is a tropical tree native to the Isthmus of Panama, now grown throughout the tropics. **Mature Size**: Fast-growing tree reaching 20 meters in height. **Distinctive Features**: Evergreen leaves with golden underside that shines when viewed from distance. **Fruit**: Globose fruits 2-3 inches in diameter, typically purple with radiating star pattern visible in pulp. **Varieties**: Purple (most common), greenish-brown (thin skin, liquid pulp), and yellow (less common). **Flavor**: Sweet dessert fruit, often served chilled. **Production**: Hermaphroditic (self-fertile) with tiny purplish-white fragrant flowers. **Cultural significance**: Name likely from Mayan words meaning 'breast juice sap'. **Commercial use**: Primarily eaten fresh as dessert fruit.",
        cultivation_tips: "**Climate**: Tropical, grows rapidly in warm humid conditions. **Soil**: Adaptable to various soil types, prefers well-drained fertile soil. **Light**: Full sun for best fruit production. **Hawaii-specific**: Well-suited to Hawaii's tropical climate, thrives at sea level to moderate elevations. **Water**: Regular watering during establishment, somewhat drought tolerant once mature. **Spacing**: Allow 20-30 feet between trees due to large mature size. **Production**: Self-fertile, begins fruiting relatively quickly after establishment. **Seasonal**: Seasonal fruit bearing tree with distinct harvest periods.",
        pest_management: "**General care**: Monitor for typical tropical fruit tree pests. **Latex content**: Fruit skin rich in latex - handle carefully during harvest. **Disease resistance**: Generally hardy with good natural disease resistance. **Hawaii-specific**: Watch for introduced fruit flies and scale insects. **Environmental**: Protect young trees from strong winds. **Maintenance**: Regular inspection and removal of damaged or diseased fruit.",
        pruning_guidelines: "**Size management**: Regular pruning to control large size and improve harvest access. **Structure**: Develop strong scaffold branches to support heavy fruit loads. **Air circulation**: Prune to improve airflow and light penetration. **Timing**: Prune after harvest season. **Safety**: Use caution due to latex in plant parts. **Ornamental value**: Pruning maintains attractive canopy shape and enhances golden leaf undersides. **Production**: Selective pruning can improve fruit quality and size."
    },
    {
        name: "Lychee",
        ...
        emoji: "🍇",
        rare: true,
        general_info: "Lychee (*Litchi chinensis*) is a monotypic taxon and sole member of genus *Litchi* in the soapberry family Sapindaceae. **Mature Size**: Tall evergreen tree native to South China, Malaysia, and northern Vietnam. **Subspecies**: Three distinct subspecies - Indochinese (most common), Philippine (*alupag* or *matamata*), and Javanese. **Fruit**: Small fleshy sweet drupes with pink-red, rough-textured soft shell. **Flavor**: Sweet, aromatic flesh with floral notes. **Production**: China is main producer, followed by India and Vietnam. **Cultural significance**: Cultivation documented in China from 11th century. **Commercial**: Widely cultivated throughout Southeast Asia and South Asia. **Caution**: Seeds contain compounds that can cause hypoglycemia in undernourished children.",
        cultivation_tips: "**Climate**: Tropical to subtropical, requires warm humid conditions. **Soil**: Well-drained, slightly acidic soil preferred. **Light**: Full sun for best fruit production. **Hawaii-specific**: Well-suited to Hawaii's climate, especially at elevations with good drainage. **Water**: Consistent moisture during growing season, reduce during dormancy. **Spacing**: Allow adequate space for large mature size. **Production**: Trees begin fruiting after several years from grafting. **Pollination**: Benefits from cross-pollination for better fruit set. **Harvest**: Fruits ripen in clusters, harvest when fully colored.",
        pest_management: "**Disease resistance**: Generally hardy but monitor for fungal issues in humid conditions. **Common pests**: Watch for scale insects, aphids, and fruit flies. **Hawaii-specific**: Monitor for introduced pests common to tropical fruit trees. **Environmental**: Protect from strong winds that can damage branches. **Seed toxicity**: Handle seeds carefully due to toxic compounds. **Preventive care**: Good air circulation and proper spacing reduce disease risk.",
        pruning_guidelines: "**Shape maintenance**: Regular pruning to maintain manageable size and attractive form. **Structure**: Develop strong framework to support heavy fruit clusters. **Air circulation**: Prune to improve airflow and reduce disease risk. **Timing**: Prune after harvest season. **Size control**: Can be kept smaller through regular pruning. **Production**: Selective pruning improves fruit quality and harvest access. **Safety**: Use proper tools and techniques for large tree pruning."
    },
    {
        name: "Sapodilla",
        botanical: "Manilkara zapota",
        ...
        emoji: "🟤",
        rare: true,
        general_info: "Sapodilla (*Manilkara zapota*), also known as sapote, chicozapote, chicoo, naseberry, or soapapple, is an evergreen tree native to southern Mexico and Central America. **Mature Size**: Can grow over 30m (98 ft) tall with trunk diameter up to 1.5m (5 ft), but cultivated specimens average smaller. **Longevity**: Trees can live up to 100 years. **Fruit**: Brown, rough-skinned oval fruits with sweet, malty flavor and grainy texture. **Production**: Introduced to Philippines during Spanish colonization, now grown throughout tropical Asia. **Cultural significance**: Name derives from Spanish 'little sapote', ultimately from Nahuatl 'tzapotl'. **Commercial**: Grown in large quantities in Mexico, India, Thailand, Malaysia, and Caribbean. **Uses**: Eaten fresh, made into desserts, and historically source of chicle for chewing gum.",
        cultivation_tips: "**Climate**: Tropical, requires consistently warm temperatures. **Soil**: Adaptable to various soil types, prefers well-drained fertile soil. **Light**: Full sun for best fruit production. **Hawaii-specific**: Well-suited to Hawaii's tropical climate, thrives at sea level to moderate elevations. **Water**: Regular watering during establishment, drought tolerant once mature. **Spacing**: Allow adequate space for large mature size. **Production**: Trees begin fruiting after several years, can produce for decades. **Harvest**: Fruits ripen year-round in tropical climates. **Patience required**: Slow-growing but long-lived and productive.",
        pest_management: "**Disease resistance**: Generally hardy with good natural disease resistance. **Common pests**: Monitor for scale insects, fruit flies, and mealybugs. **Hawaii-specific**: Watch for introduced tropical fruit pests. **Environmental**: Protect young trees from strong winds. **Maintenance**: Regular inspection and removal of damaged fruit. **Preventive care**: Good air circulation and proper spacing reduce disease risk. **Natural resilience**: Long-lived trees with strong natural pest resistance.",
        pruning_guidelines: "**Size management**: Regular pruning to control large size and improve harvest access. **Structure**: Develop strong scaffold branches for long-term fruit production. **Air circulation**: Prune to improve airflow and light penetration. **Timing**: Prune during dry periods to reduce disease risk. **Longevity focus**: Light pruning to maintain tree health for decades of production. **Safety**: Use proper equipment for large tree pruning. **Production**: Selective pruning improves fruit quality and ease of harvest."
    },
    {
        name: "Mangosteen",
        botanical: "Garcinia mangostana",
        ...
        emoji: "👑",
        rare: true,
        general_info: "Mangosteen (*Garcinia mangostana*), known as the 'Queen of Fruits', is a tropical evergreen tree native to Island Southeast Asia. **Mature Size**: Grows 6-25 meters (20-82 ft) tall with dense, pyramidal crown. **Fruit**: Deep purple rind when ripe containing sweet, tangy, juicy white flesh segments. **Flavor**: Considered one of the world's finest fruits with complex sweet-tart flavor. **Production**: Cultivated extensively in tropical Asia since ancient times. **Cultural significance**: Highly prized throughout Southeast Asia, often called the queen of tropical fruits. **Commercial**: Grown mainly in Southeast Asia, with introductions to Colombia, Puerto Rico, and Florida. **Unique feature**: Fruit develops without fertilization (agamospermy). **Premium status**: Commands high prices in international markets.",
        cultivation_tips: "**Climate**: Strictly tropical, requires consistently warm temperatures above 0°C (32°F). **Soil**: Prefers deep, well-drained, organic-rich soil with good moisture retention. **Light**: Partial shade when young, full sun when mature. **Hawaii-specific**: Challenging in Hawaii due to specific climate requirements, best in protected locations. **Water**: Consistent moisture essential, sensitive to both drought and waterlogging. **Spacing**: Allow ample space for large mature size. **Production**: Very slow-growing, takes 10-20 years to fruit from seed. **Patience required**: Extremely slow establishment but long-term producer. **Temperature sensitivity**: Cannot tolerate any frost or extended cool periods.",
        pest_management: "**Disease susceptibility**: Sensitive to root rot in poorly drained soils. **Environmental stress**: Highly sensitive to temperature fluctuations and drought. **Hawaii-specific**: Monitor for scale insects and tropical fruit pests. **Root protection**: Ensure excellent drainage to prevent root diseases. **Climate protection**: Protect from any temperature extremes. **Maintenance**: Minimal pest issues but requires optimal growing conditions. **Preventive care**: Focus on maintaining ideal environmental conditions rather than pest control.",
        pruning_guidelines: "**Minimal pruning**: Requires very little pruning due to naturally good form. **Structure**: Light shaping when young to develop strong framework. **Air circulation**: Remove only dead, diseased, or crossing branches. **Timing**: Prune minimally during dry periods. **Caution**: Avoid heavy pruning as trees are slow to recover. **Natural form**: Allow tree to develop its natural pyramidal shape. **Production focus**: Minimal intervention to avoid stress on slow-growing tree."
    }
];