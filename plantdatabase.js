window.plantsDatabase = [
    // BANANAS
    {
        ...
        general_info: "Apple Banana (*Musa acuminata*) is a giant herbaceous perennial native to Tropical Asia, cultivated for at least 4,000 years. Grows 10-15 feet (3-4.5 meters) tall with pseudostem diameter of 8-12 inches. Large paddle-shaped leaves up to 6 feet long and 2 feet wide attached to stout midrib. Canoe plant brought to Hawaii by Polynesian settlers. Takes 10-12 months from planting to fruiting. Produces virgin fruit (parthenocarpy) - seeds rarely produced. Pseudostem dies after flowering, new growth emerges from underground rhizomes and suckers. Fruit eaten fresh or cooked, male flowers edible, young shoots for stir-fries, leaves for wrapping food and plates, stem fibers for cloth. Fourth largest crop worldwide.",
        cultivation_tips: "Plant in organically rich, well-draining soil - thrives in abandoned mulch/compost piles as heavy feeder. Full sun preferred, tolerates some shade especially during heat of day. Needs consistently moist soil - irrigation may be necessary during drought. Plant in areas protected from strong winds (normal trade winds fine) to prevent leaf shredding. Plant deeper for better wind resistance. Allow 6-8 feet between plants for sucker development. Grows best 65-90°F, thrives in USDA zones 9-11. Heavy feeder - fertilize regularly with balanced fertilizer during growing season.",
        pest_management: "Scale insects, aphids, whitefly, broad mite (causes leaf curling). Monitor for Chinese rose beetle, citrus swallowtail caterpillar. Watch for Panama disease and banana bunchy top virus - source plants from reputable suppliers. Avoid overwatering to prevent root rot. Encourage natural predators for pest control. Remove damaged foliage promptly to prevent disease spread.",
        pruning_guidelines: "Remove dead, damaged, or yellowing leaves regularly by cutting close to pseudostem. Cut fruiting pseudostem to ground level after harvest to allow new shoots to develop. Allow 2-3 healthy suckers per mat for continuous production - remove excess suckers. Each pseudostem lives only long enough to flower and fruit (10-12 months). Remove damaged leaves after storms to prevent disease entry points."
    },
    {
        ...
        general_info: "Dwarf Cavendish (*Musa acuminata*) is a compact banana variety perfect for home gardens and containers. Grows 5-10 feet (1.5-3 meters) tall with pseudostem diameter of 6-8 inches. Compact form with proportionally smaller leaves than standard varieties. Award-winning for manageable size and reliable fruit production. Excellent for containers and can be grown as summer bedding plant. Can be brought indoors in cooler climates. One of most popular banana varieties for home cultivation due to space efficiency. Produces standard-sized bananas despite compact plant size.",
        cultivation_tips: "Full sun to partial shade - adapts well to various light conditions. Organically rich soil with excellent drainage essential. Regular watering but allow soil to dry slightly between waterings to prevent root rot. Excellent for containers - use large pots (20+ gallons) with drainage holes. Balanced fertilizer every 4-6 weeks during growing season. Needs temperatures above 60°F (15°C) to thrive. Perfect for smaller yards and urban gardens. Can overwinter indoors in bright location with adequate humidity.",
        pest_management: "Watch for scale, aphids, and spider mites especially when grown indoors or in containers. Good airflow essential to prevent fungal issues, especially important for container plants. Remove damaged foliage promptly to prevent disease spread. Monitor more closely for pests when grown in containers as they're more stressed. Quarantine new plants and inspect regularly.",
        pruning_guidelines: "Remove dead or yellowing leaves by cutting close to main pseudostem. Cut fruiting pseudostem to ground level after harvest to allow new shoots to develop. Regular removal of excess suckers focuses energy on fruit production - especially important for container plants. Compact nature requires minimal pruning for size management. More frequent leaf removal may be needed for container plants."
    },
    {
        name: "Lactan Banana",
        botanical: "Musa acuminata",
    ...
    },
    {
        ...
        emoji: "🍌",
        rare: true,
        plant_photo: "https://www.epicgardening.com/wp-content/uploads/2020/08/A-shot-of-several-fruits-leaves-the-true-stem-and-a-red-flower-of-a-tree.jpg",
        flower_photo: "https://www.epicgardening.com/wp-content/uploads/2020/08/A-shot-of-several-fruits-leaves-the-true-stem-and-a-red-flower-of-a-tree.jpg",
        fruit_photo: "https://www.epicgardening.com/wp-content/uploads/2020/08/A-shot-of-several-green-colored-unripe-fruits.jpg",
    ...
    // CITRUS
    {
        ...
        general_info: "Lemon (*Citrus limon*) originated in subtropical South and Southeast Asia and is among the most popular citrus for home gardens. Typically grows 10-20 feet (3-6 meters) tall with canopy spread of 12-15 feet and trunk diameter of 8-12 inches. Relatively small, widely adapted evergreen tree with thorny branches. Meyer lemon particularly adaptable and can be grown in nearly every location in Hawaii. Can fruit year-round in Hawaii's climate with peak seasons. Grows best in sunny locations with temperatures 65-90°F (18-32°C). Excellent choice for Hawaii home gardens due to size and productivity.",
        cultivation_tips: "Plant in full sunlight protected from strong winds. 15-20 feet from other trees to accommodate mature size. Well-drained soil with pH 6-7 essential for optimal growth. Apply balanced fertilizer (16-16-16) regularly during growing season, increasing amounts as tree matures. Deep watering with soil drying slightly between waterings. Trees can be planted year-round but may need winter protection at cooler elevations above 2,000 feet. Dwarf varieties suitable for containers in smaller spaces.",
        pest_management: "Scale insects, aphids, whitefly, broad mite (causes leaf curling). Chinese rose beetle, citrus swallowtail caterpillar, citrus blackfly, citrus leafminer common. Foot rot if graft union too close to ground. Citrus tristeza virus prevalent in Hawaii - minimize effects with proper rootstock selection. Encourage natural predators for pest control. Good sanitation and proper cultural practices reduce pest pressure.",
        pruning_guidelines: "Remove dead branches and crossing limbs to maintain tree health. Remove suckers and shoots from rootstock below graft union. Thin interior branches to allow light penetration and air movement. Best pruning time is just after harvest in Hawaii. Avoid pruning just before flowering as this reduces fruit production. Severe pruning causes vigorous vegetative growth and decreased yield - use light, regular pruning instead."
    },
    {
        name: "Lime",
   ...
   // THEOBROMA
    {
        ...
        general_info: "Criollo x Steve Cacao is a rare hybrid variety of *Theobroma cacao*, crossing traditional Criollo genetics with modern cultivars. Grows 15-25 feet (4.5-7.5 meters) tall with trunk diameter of 8-12 inches and canopy spread of 12-20 feet. Small to medium evergreen tree with large, drooping leaves and cauliflorous flowers/pods growing directly from trunk and branches. Criollo known as 'Aristocrat of Cacao' for delicate, complex flavors with floral and fruity notes. Represents less than 1% of global chocolate production due to disease susceptibility and lower yields. Highly prized among chocolate connoisseurs and bean-to-bar producers for exceptional flavor profile.",
        cultivation_tips: "Requires tropical climate within 20 degrees north/south of equator. Rich, well-drained soils with consistent moisture but not waterlogged. Grows best with light shade protection - plant as understory crop under shade trees like banana or coconut. Optimal range 70-85°F (21-29°C) with high humidity. Grafted trees begin fruiting in 4-5 years. Thrives in windward areas with consistent rainfall and humidity. Shield from strong winds which damage large leaves and developing pods. Plant 12-15 feet apart in agroforestry systems.",
        pest_management: "Highly susceptible to fungal diseases in wet conditions. Phytophthora pod rot, black pod disease, frosty pod rot, witches' broom disease. Scale insects and aphids problematic. Ensure excellent air circulation and avoid overhead watering. Remove infected pods promptly to prevent disease spread. Monitor closely during wet seasons. Proper spacing and pruning essential for disease prevention.",
        pruning_guidelines: "Prune to maintain 20 feet (6 meters) height for easier harvesting and disease management. Create open structure for light penetration and air circulation - critical for disease prevention. Remove suckers and water sprouts regularly. Prune during dry season to reduce disease risk. Shape tree with 3-4 main scaffold branches. Remove dead or diseased wood promptly to prevent pathogen spread."
    },
    {
    ...
    // FRUIT
    {
        ...
        emoji: "🥭",
        rare: true,
        general_info: "Maprang (*Bouea macrophylla*), also called Marian Plum or Gandaria, is an evergreen fruit tree in the cashew family native to Southeast Asia. Trees reach 80 feet (25 meters) tall in natural conditions with a trunk diameter of 2-3 feet and canopy spread of 40-50 feet. In cultivation, trees are typically maintained at 25-40 feet through pruning. Dense, pyramidal crown with lanceolate leaves 13-45cm long. Produces small mango-like fruits 2-5cm diameter that ripen from green to yellow-orange. The entire fruit including skin is edible with sweet-sour flavor reminiscent of mango and plum. Takes 10-15 years from seed to first harvest, but grafted trees fruit in 5-6 years. Productive lifespan exceeds 30 years with mature trees yielding up to 440 pounds annually. In Hawaii's climate, flowering typically occurs during cooler, drier periods.",
        cultivation_tips: "Thrives in Hawaii's humid tropical climate with well-distributed rainfall. Grows best in fertile, well-draining soil with regular moisture. Standard spacing 32×40 feet (34 trees/acre) or intensive 17×17 feet (150 trees/acre) with regular pruning. Plant in full sun with protection from strong winds. Young trees benefit from partial shade for first 6 months. Seeds only (no vegetative propagation), though grafting onto rootstock speeds fruiting. Performs well at elevations up to 2,000 feet. Water stress during dry periods can trigger flowering. Mulch heavily and fertilize regularly with balanced fertilizer plus micronutrients. In Hawaii, fruiting season may extend longer than native range due to year-round growing conditions.",
        pest_management: "Monitor for fruit flies (Oriental and Mediterranean) which are major pests in Hawaii - use protein bait traps and remove fallen fruit promptly. Watch for scale insects, mealybugs, and aphids common to tropical fruit trees. Anthracnose (Colletotrichum) can cause fruit rot and leaf spots, especially during wet periods - ensure good air circulation and avoid overhead watering. Root rot possible in poorly drained soils. Coqui frogs may damage young trees. Use integrated pest management and maintain good garden sanitation. Consider beneficial insects for biological control.",
        pruning_guidelines: "Essential for size management and fruit accessibility. Develop strong central leader with well-spaced scaffold branches. Remove dead, diseased, crossing branches and water sprouts. Maintain pyramidal shape with open center for light penetration. Regular pruning keeps trees at manageable 25-30 feet height for easier harvesting. Prune after harvest in Hawaii (typically late summer). Intensive pruning systems allow closer spacing but require more frequent maintenance. Remove lower branches to facilitate ground management and improve air circulation."
    },
    {
        name: "Marang",
        ...
        emoji: "🍈",
        rare: true,
        general_info: "Marang (*Artocarpus odoratissimus*) is an evergreen fruit tree in the mulberry family, closely related to jackfruit and breadfruit. Native to Borneo, Palawan, and Mindanao Island. Reaches 82 feet (25 meters) tall with trunk diameter up to 20 inches (50cm) and sometimes develops buttressed roots. Upright crown with leaves 16-50cm long, similar to breadfruit but less lobed with prominent yellow venation. Round to oblong fruits 15-20cm long, weighing about 2 pounds (1kg) with soft spines that harden as fruit matures. White flesh segments are superior in taste to jackfruit - sweet, creamy, and easier to eat with no latex. Fast-growing, begins fruiting at 4-6 years. In Hawaii, has distinct fall and winter fruiting seasons with bumper crops some years.",
        cultivation_tips: "Thrives in Hawaii's humid tropical climate with high rainfall (1500-5000mm annually). Requires deep, well-draining soil and consistent moisture - needs lots of water throughout growing season. Plant 30-40 feet apart to accommodate mature size. Young plants need partial shade, mature trees require full sun. Performs well from sea level to 1,500 feet elevation. Protect from strong trade winds which can damage the large leaves and break branches. Critical to harvest fruit while green and firm, then allow to ripen off-tree to prevent dangerous falling of heavy fruit. Fruit changes to greenish-yellow when ripe and should be consumed quickly after opening.",
        pest_management: "Generally hardy with few serious pest issues in Hawaii. Fruit flies (Oriental and Mediterranean) - use protein bait traps and maintain sanitation by removing fallen fruit immediately. Monitor for root rot in poorly drained soils, especially during heavy rainfall periods. Not wind tolerant - provide windbreaks and prune to reduce wind resistance. Watch for scale insects and mealybugs. Coqui frogs may damage young trees. Ensure good drainage during wet seasons to prevent fungal issues.",
        pruning_guidelines: "Essential to maintain manageable height since 25-pound fruit falling from 25+ feet is extremely dangerous. Develop strong central leader with well-spaced scaffold branches when young. Remove dead, diseased, or crossing branches. Prune to maintain height at 15-20 feet for safe harvesting. Prune after harvest season in Hawaii (typically late winter/early spring). Create open center for good air circulation and light penetration. Remove lower branches to facilitate ground management. Regular pruning reduces wind resistance and prevents storm damage."
    },
    {
        ...
        emoji: "🍎",
        rare: true,
        general_info: "Purple Malay Apple (*Syzygium malaccense*), known as 'ōhi'a 'ai in Hawaiian, is a culturally significant canoe plant brought to Hawaii by Polynesian settlers 1000-1700 years ago. Grows 40-60 feet tall with trunk diameter of 2-3 feet and canopy spread of 30-40 feet. Fast-growing evergreen with dark glossy opposite leaves and spectacular hot pink flowers that bloom directly from trunk and branches (cauliflory). Pear-shaped waxy fruits 2-6 inches long, ranging from white to deep red to magenta with crisp, juicy, sweet flesh and hint of rose flavor. Produces up to 2 crops annually in Hawaii's climate. Provided fruit, wood for carving, spiritual offerings, and decorations for Native Hawaiians. Creates stunning hot pink carpet when flowers fall.",
        cultivation_tips: "Thrives in Hawaii's tropical climate but damaged by any freezing temperatures. Primary need is constant water availability year-round - grows best with 60+ inches annual rainfall. Adapts to any well-draining soil type from sea level to 9,000 feet elevation. Plant 30-40 feet apart to accommodate mature size. Seeds lose viability quickly; use air layering, budding, or cuttings for true-to-type varieties. Grows exceptionally well in mid-elevation rainforest areas (1,000-3,000 feet) rather than sea level. Easy to grow with minimal care beyond consistent irrigation. Fruit bruises easily when picked, handle carefully.",
        pest_management: "Generally pest-resistant with few serious issues in Hawaii. Monitor for scale common to Syzygium species - treat with horticultural oil if needed. Oriental and Mediterranean fruit flies may attack ripening fruit - use protein bait traps during fruiting season. Often attracted to fruit - beneficial for seed dispersal but may require netting for fruit protection. Maintain good sanitation by removing fallen fruit promptly to prevent pest breeding. Watch for introduced pests but generally very hardy. Not considered invasive in Hawaii.",
        pruning_guidelines: "Essential since trees can reach 60 feet - prune to maintain manageable height of 25-35 feet for harvesting. Prune after fruiting to encourage next season's flower production. Light annual pruning preferred over heavy pruning. Remove dead, diseased, crossing branches and water sprouts. Since flowers bloom directly from trunk and branches (cauliflory), avoid excessive pruning of main trunk areas. Shape crown for good air circulation and light penetration. Remove lower branches to facilitate ground management. Can prune year-round but avoid during peak flowering periods."
    },
    {
        name: "Black Sapote",
        ...
        emoji: "🖤",
        rare: true,
        general_info: "Black Sapote (*Diospyros nigra*), known as chocolate pudding fruit or black persimmon, is a tropical fruit tree in the persimmon family native to Mexico and Central America. Medium trees 25-30 feet (7.6-9.1m) to large trees 30-80 feet (9.1-24.4m) tall with oblong canopy. In Hawaii, typically reaches medium size. Evergreen with alternate, oblong, leathery leaves 4-12 inches long, glossy dark green. Oblate to globose fruits 2-6 inches diameter with dark olive-green skin, turning brown to black when ripe with soft custard-like pulp resembling chocolate pudding. Usually dioecious (separate male/female trees). Grafted trees fruit in 2-3 years, seedlings 5-6 years. Large trees produce several hundred pounds annually. Harvest varies: December-February or June-August in different climates.",
        cultivation_tips: "Adapted to tropical and warm subtropical areas from sea level to 6,000 feet elevation. Not cold hardy - young trees damaged at 30°F (-1°C), mature trees at 28°F (-2°C). Plant 25-30 feet from buildings and other trees to accommodate mature size. Grows well in most well-drained soil types including sandy and limestone-based high-pH soils. Flood tolerant but only moderately drought tolerant. Plant in full sun in warmest, well-draining area of landscape. May require both male and female trees for fruit production. Varieties like 'Merida' and 'Bernicker' available. Superior varieties propagated by budding/grafting rather than seeds.",
        pest_management: "Generally healthy with few serious pest issues in Hawaii. Select healthy nursery trees and avoid root-bound specimens. Ensure good drainage to prevent root rot, especially during wet seasons. Trees can withstand moderate winds if regularly pruned to limit size and open canopy. Monitor for typical tropical fruit tree pests like scale insects and fruit flies. Maintain good sanitation around tree. Generally very hardy once established.",
        pruning_guidelines: "Essential to prune regularly to limit tree size and open canopy to wind movement - helps trees withstand hurricane-force winds without toppling. Shape young trees to develop strong central structure with well-spaced scaffold branches. Remove dead, diseased, damaged wood and crossing branches. Regular pruning keeps trees at manageable size for harvesting and reduces wind resistance. Pruning improves fruit accessibility and overall tree management. Can prune year-round in Hawaii but avoid during flowering periods when possible."
    },
    {
        ...
        emoji: "🫐",
        rare: true,
        general_info: "Kwai Muk (*Artocarpus hypargyreus*), also known as Chinese Mulberry or Monkey Jack, is a rare tropical fruit tree native to southern China and Vietnam. Grows 33-50 feet (10-15 meters) tall with dense, rounded canopy and trunk diameter of 12-18 inches. Large, glossy, deeply lobed leaves create attractive dense foliage. Shade tolerant and can establish in forest understory. Small round to oval fruits 1-2 inches diameter, yellow to orange when ripe with sweet-tart flavor reminiscent of apricot, fig, and citrus. Self-fertile, reaches maturity in 2.5 years and begins fruiting in 3-4 years. Fruit, leaves, and seeds all edible with traditional culinary and medicinal uses. Considered low invasion risk in Hawaii despite broad adaptability.",
        cultivation_tips: "Thrives in Hawaii's tropical climate with broad elevation tolerance. Tolerates many soil types - not limited by substrate, grows in well-draining fertile soil with pH 6.0-7.0. More cold hardy than jackfruit - mature trees survive brief exposure to 25-26°F (-4°C). Full sun preferred (6-8 hours daily) but shade tolerant. Regular watering during dry periods but avoid overwatering as roots prone to rot. Slow-growing initially but productive once established. Can be grown in containers. Plant 25-30 feet apart to accommodate mature canopy spread. Self-pollinating, reproduces by seed.",
        pest_management: "Generally hardy with few serious pest issues in Hawaii. Ensure good drainage to prevent root rot, especially during wet periods. Monitor for scale insects and aphids occasionally. Watch for typical tropical fruit tree pests. Young trees may need protection from strong winds. Seeds dispersed by frugivorous birds - maintain area around tree to prevent unwanted seedlings. Good air circulation and proper spacing reduce disease risk. Generally very low maintenance once established.",
        pruning_guidelines: "Moderate pruning required to maintain balanced shape and manageable size. Shape when young to develop strong framework and prevent overcrowding of branches. Remove dead, damaged, or crossing branches. Light pruning helps control size and improves air circulation. Can be shaped as attractive specimen tree due to glossy foliage and dense growth habit. Prune after fruiting season in Hawaii. Regular pruning keeps tree at manageable height for harvesting and reduces wind resistance."
    },
    {
        ...
        emoji: "🟣",
        rare: true,
        general_info: "Purple Mangosteen (*Garcinia mangostana*), the 'Queen of Fruits,' is a tropical evergreen tree native to Island Southeast Asia. Grows 20-82 feet (6-25 meters) tall with pyramidal crown and trunk diameter of 12-24 inches. Extremely slow-growing with glossy dark green leaves. Thick purple rinds when ripe containing sweet, tangy, juicy white flesh segments with fluid-filled vesicles similar to citrus. Ultra-tropical requirements - takes 8-15+ years to fruit from seed, often 12+ years, but can live and produce for over 100 years. Mature trees yield 200-3,000 fruits per season. Requires very specific conditions - usually grown within 10 degrees of equator without dry seasons. Trees are typically female-only in cultivation (agamospermy - fruit forms without fertilization).",
        cultivation_tips: "Needs warm, humid climate with temperatures 77-95°F (25-35°C) and relative humidity over 80%. Cannot tolerate temperatures below 68°F (20°C) or above 100-104°F (38-40°C). Well-draining soil with pH 5-6 (tolerates 4.3-7.5). Requires up to 150 inches (380cm) annual rainfall but cannot tolerate waterlogging. Challenging to grow - best in protected, humid microclimates at 1,000-3,000 feet elevation. Plant in areas sheltered from winds and salt spray. Young trees need shade - intercrop with banana, plantain, coconut. Minimum 8 years to fruit, often 12+ years. Typically by seeds; trees are functionally female-only.",
        pest_management: "Monitor for leaf spotting fungi like Pestalotiopsis species causing brown leaf spots with yellow halos, especially problematic in high humidity. Prevent root rot with excellent drainage - cannot tolerate waterlogged conditions. Watch for scale insects and mealybugs. Very sensitive to temperature fluctuations, wind damage, and salt spray. Maintain consistent moisture without waterlogging, provide wind protection, ensure good air circulation. Considered one of the most difficult tropical fruits to grow successfully outside native range.",
        pruning_guidelines: "Very slow growth means pruning should be conservative and infrequent. Shape young trees to develop strong central leader and well-spaced branches. Remove only dead, diseased, or damaged wood. Prune during dry periods to reduce disease risk. Generally maintains manageable size naturally due to slow growth. Avoid heavy pruning which can stress the already slow-growing tree. Prune to improve air circulation and reduce wind resistance in Hawaii's conditions."
    },
    {
        name: "Bacuri",
        ...
        emoji: "🟡",
        rare: true,
        general_info: "Bacuri (*Platonia insignis*) is a dry-season deciduous tree native to South America's humid forests, especially the Amazon Rainforest of Brazil, Paraguay, Colombia, and Guyana. Reaches 82-131 feet (25-40 meters) tall with pyramidal crown and trunk diameter of 2-4 feet. Opposite, simple oblong leaves 8-15cm long, glossy dark green with wavy margins. Copious yellow latex in bark. Round to oval fruits 7-14cm long with thick yellow skin resembling papaya. Sticky white pulp is fragrant with sweet-sour taste. Contains 3-5 seeds. High in phosphorus, iron, and vitamin C. Ornithophilous - pollinated by white-bellied parrots. Fruit made into condiments and beverages; seeds yield oil for skin conditions; yellowish wood used as timber.",
        cultivation_tips: "Requires humid tropical climate with distinct dry season when tree becomes deciduous. Fertile, well-draining soil rich in organic matter with consistent moisture during growing season. Full sun to light shade exposure. Challenging to grow due to need for distinct dry season - may perform better in leeward areas with seasonal rainfall patterns. Trees begin fruiting at 10 feet (3 meters) height, typically 3-6 years from seed. Plant 40-50 feet apart to accommodate large mature size. Consistent watering during growing season, reduced during dormant period.",
        pest_management: "Monitor for fungal issues during humid periods - ensure good air circulation. Handle with care as bark exudes copious yellow latex which may cause skin irritation. Watch for typical tropical fruit tree pests like scale insects and fruit flies. Young trees need protection from strong winds and intense sun until established. Good drainage essential while maintaining soil moisture during growing season.",
        pruning_guidelines: "Prune during dry season when tree is naturally deciduous. Shape young trees to develop strong pyramidal framework to support large mature size. Remove dead, damaged, or crossing branches. Light pruning to maintain manageable height for fruit harvesting - trees can become very large. Prune to improve airflow and reduce fungal disease risk in humid conditions. Focus on developing strong scaffold branches to support heavy fruit loads."
    },
    {
        ...
        emoji: "🟡",
        rare: true,
        general_info: "Mameyito (*Garcinia intermedia*), also known as Lemon Drop Mangosteen, is a tropical fruit tree native to southern Mexico and Central America. Small bush or tree reaching 10-15 feet (3-5 meters) tall with compact growth habit. Fast-growing evergreen with opposite, stiff leaves 8-15cm long and 2-5cm wide. Dark brown trunk with yellow latex. Round fruits with thin orange to reddish peel and whitish aromatic pulp (aril) with sweet-sour taste. Contains 1-2 seeds. Fast producer - may fruit within 2 years of planting. Fruits more prolifically in full sun. June-August in native range. Excellent for containers and ornamental purposes. Hardy to 30°F (-1.1°C).",
        cultivation_tips: "Requires humid tropical climate with consistent warmth. Part shade to full sun - fruits more prolifically in full sun. Tolerant of wide range of soils with good drainage. Regular watering with well-draining soil. Well-suited to Hawaii's climate and performs well from sea level to mid-elevations. Compact size (10-15 feet) allows closer spacing - plant 15-20 feet apart. Excellent choice for container cultivation due to small size. Often fruits within 2 years, making it ideal for impatient gardeners. Attractive tree especially when in fruit, which may be year-round in ideal conditions.",
        pest_management: "Generally hardy with few serious pest issues reported. Monitor for scale insects and fruit flies during fruiting season. Watch for pests common to Garcinia species. Good drainage essential to prevent root problems in wet conditions. Maintain good air circulation and sanitation around tree. Considered relatively pest-resistant compared to other tropical fruits.",
        pruning_guidelines: "Angular growth habit lends itself well to espalier training. Light pruning to maintain shape and manageable size. Can be kept compact for easier fruit harvesting and container growing. Regular pruning improves airflow and reduces disease pressure in humid climates. Prune after fruiting season in Hawaii. Responds well to pruning for ornamental purposes. Easy to maintain at desired height due to naturally compact growth."
    },
    {
        ...
        emoji: "🟠",
        rare: true,
        general_info: "Achachairu (*Garcinia humilis*), also known as Orange Mangosteen or Bolivian Mangosteen, is a small pyramidal tree native to the Amazon basin in Bolivia. Grows 10-20 feet (3-6 meters) tall with compact pyramidal canopy and trunk diameter of 8-12 inches. Slow-growing initially with glossy leaves darker green above, lighter underneath. Bright orange egg-shaped fruits with tangy-refreshing flavor balancing sweetness and acidity. Prolific fruiting after establishment - typically begins bearing after 6 years. Name 'Achachairu' means 'honey kiss' in Guarani language. Fruit should be picked mature as it doesn't ripen further after storage. Successfully commercialized in Australia under name 'Achacha'.",
        cultivation_tips: "Native to medium-altitude rainforests - grows well in shady, humid climates (USDA zones 10-13). Requires good porosity and consistent moisture with excellent drainage. Tolerates shade but produces better in partial sun. Well-suited to Hawaii's humid climate, performs well at 500-2,000 feet elevation. Consistent moisture essential but avoid waterlogging. Compact size allows 15-20 feet spacing. Excellent for containers due to manageable size. Slow initial growth but eventually fruits abundantly. Needs frost protection in marginal climates.",
        pest_management: "Generally hardy with good natural resistance. Monitor for fungal issues during wet periods - ensure good air circulation. Watch for scale insects and typical tropical fruit tree pests. Young trees may need protection from strong trade winds. Good drainage essential to prevent root problems. Considered relatively easy to grow once established.",
        pruning_guidelines: "Light pruning to maintain attractive pyramidal shape and manageable size. Remove dead, diseased, or crossing branches to maintain tree health. Prune to improve airflow and light penetration, especially important in humid conditions. Regular pruning maintains attractive appearance while improving fruit production and harvest access. Prune after harvest in Hawaii. Easy to maintain at desired height due to naturally compact growth habit."
    },
    {
        ...
        emoji: "🔴",
        rare: true,
        general_info: "Fingersop (*Meiogyne cylindrocarpa*), also known as Red Paipai, is a rare tropical fruit tree in the Annonaceae family (custard apple family). Small to medium tree reaching 15-25 feet (4.5-7.5 meters) tall with trunk diameter of 6-10 inches. Evergreen tree with simple, alternate leaves and distinctive finger-like cylindrical fruits. Native to Southeast Asia including Indonesia, Malaysia, and Philippines. Listed as Least Concern by IUCN. Related to soursop, cherimoya, and sugar apple but represents much less common genus. Limited cultivation outside native range due to specialized requirements and lack of commercial development.",
        cultivation_tips: "Requires tropical climate with high humidity and consistent warmth year-round. Well-draining, fertile soil rich in organic matter essential. Benefits from partial shade during establishment, especially protection from harsh direct sunlight when young. Needs shelter from strong winds which can damage leaves and developing fruits. May perform well in protected windward locations with consistent moisture. Plant 15-20 feet apart to accommodate mature size. Slow initial growth typical of Annonaceae family. Limited cultivation information available due to uncommon status in commercial agriculture.",
        pest_management: "Monitor for typical Annonaceae family pests including scale insects and mealybugs. Watch for fungal issues common in humid tropical conditions - ensure excellent air circulation. Avoid waterlogged conditions which can cause root rot. Limited specific pest information due to rare cultivation - follow general tropical fruit tree monitoring. Good sanitation and proper spacing help prevent disease issues. Handle with care as rare species may be more sensitive to stress.",
        pruning_guidelines: "Minimal pruning recommended due to limited cultivation experience and potential sensitivity. Remove dead, diseased, or damaged wood carefully. Light pruning to improve structure and air circulation. Prune during dry periods to reduce disease risk. Annonaceae family trees can be sensitive to heavy pruning - use light, gradual approach. Monitor tree response to any pruning and adjust techniques accordingly."
    },
    {
        ...
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Annona_mucosa_Blanco1.137.png/512px-Annona_mucosa_Blanco1.137.png",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Biriba_fruit.jpg/512px-Biriba_fruit.jpg",
        emoji: "🍐",
        rare: true,
        general_info: "Biriba (*Annona mucosa*), also known as Wild Sweetsop, Lemon Meringue Pie Fruit, or Biribá, is a fast-growing tropical tree in the Annonaceae family native to tropical South America. Reaches 13-50 feet (4-15 meters) tall with trunk diameter of 8-15 inches and spreading canopy. Fast-growing, flood-tolerant tree with large, simple leaves. Large conical or round fruits ripen from green to yellow with soft spines that bruise easily. Fruit pulp remarkably sweet, tasting like lemon meringue pie. Can bear fruit from seed within 3 years - exceptionally fast for Annonaceae family. Delicate nature and short shelf life (less than a week) limit commercial potential but make it prized for home gardens.",
        cultivation_tips: "Fast-growing with exceptional flood tolerance among fruit trees. Requires temperatures above 59°F (15°C) year-round in hot, humid tropical conditions. Sun-loving - plant in full sun for best production. Well-draining but moisture-retentive soil essential. Thrives with abundant rainfall and consistent moisture. Self-fertile but benefits from cross-pollination for better fruit set. Usually grown from seeds which remain viable 2 years when kept dry and dark. Can be grafted onto *Annona montana* or *A. glabra* rootstock for dwarfing. Excellent for wet windward locations with consistent rainfall.",
        pest_management: "Generally hardy with good natural resistance. Monitor for typical Annonaceae pests including scale insects and fruit flies. Soft, delicate fruits easily damaged - protect from physical damage and harvest carefully when fully ripe. Very short shelf life (less than a week) requires immediate consumption or processing. Watch for fruit flies during ripening season. Gentle handling essential due to fruit's delicate nature.",
        pruning_guidelines: "Light pruning to maintain shape and manageable size for easier fruit harvesting. Remove dead or damaged wood and shape young trees to develop strong framework. Avoid over-pruning as this can significantly reduce fruit production. Regular light pruning improves airflow and fruit access while maintaining natural growth habit. Prune during dry season in Hawaii to reduce disease risk. May require more frequent pruning due to vigorous growth rate."
    },
    {
    ...
    },
    {
        ...
        emoji: "🍈",
        rare: true,
        general_info: "Babaco (*Carica pentagona*), also known as Mountain Papaya, is a naturally occurring hybrid of *Carica stipulata* and *C. pubescens* from Ecuador's central south highlands. Small herbaceous shrub growing to 6 feet (1.8 meters) tall with trunk diameter of 3-4 inches. Erect softwood trunk lined with distinctive leaf scars, similar to papaya but much smaller. Distinctly five-sided fruits reaching 12 inches long and 8 inches wide, setting parthenocarpically (seedless). Very juicy flesh, slightly acidic and low in sugar with unique flavors combining strawberry, pineapple, and papaya overtones. Smooth, thin skin is completely edible. Presumed natural hybrid from Ecuadorian highlands.",
        cultivation_tips: "Thrives in cool subtropical climate, free of frost but tolerates temperatures to 28°F (-2°C) though may lose leaves. Light, fertile, well-drained soil essential with adequate rainfall or irrigation during growing phase. Feed monthly with nitrogen fertilizers during growing season - composted chicken manure makes excellent mulch. Ideally suited to container culture and excellent for greenhouse cultivation. Plant in warm location protected from winds - sunny spot preferred but tolerates shade. May perform well at higher elevations (1,000-3,000 feet) where temperatures are cooler.",
        pest_management: "Start with virus-free material essential. During moist spells, monitor for powdery mildew and Phytophthora root rot affecting leaves. Two-spotted mite (*Tetranychus urticae*) and strawberry mite (*T. atlanticus*) problematic. Most miticides phytotoxic to babaco leaves - predatory mites provide reasonable biological control. Slugs and snails can damage fruit. Plants attractive to deer who consume foliage and young fruits - protection may be needed.",
        pruning_guidelines: "For maximum fruit quality and size, allow only one trunk to grow. Remove shoots forming around base, but allow second shoot to develop from September. Don't crop one trunk for more than 1-2 years to control height. Cut trunk that bore current season fruits back to stump where second shoot was left. Second shoot becomes the new productive plant, ensuring continuous production cycle."
    },
    {
        ...
        emoji: "🟢",
        rare: true,
        general_info: "Spanish Lime (*Melicoccus bijugatus*), also known as Mamoncillo, Genip, or Quenepa, is a slow-growing tree native to northern South America and Island of Margarita. Reaches up to 85 feet (26 meters) tall with round or oval canopy and trunk diameter of 2-3 feet. Medium to large tree with alternate compound leaves having 4 opposite elliptic leaflets 2-5 inches long. Drupes borne in loose clusters, 0.3-0.8 oz each with 40-59% pulp. Green, thin but leathery brittle skin covers glistening translucent, pinkish to yellowish aril (pulp). Sweet (18.5-26% total soluble solids) with acidic overtones, rich in iron and phosphorus. Dioecious - requires both male and female trees for fruit production. 'Large', 'Jose Pabon', and 'Montgomery' available.",
        cultivation_tips: "Well-adapted to tropical and warm subtropical areas. Not freeze tolerant - young trees damaged/killed below 32°F (0°C), mature trees damaged at 27-28°F (-2.8 to -2.2°C). Prefers well-drained soil but grows in nutritionally poor soil. Tolerates very alkaline and saline soils, thrives in limestone soil with pH 8.2. Tolerant of prolonged drought but intolerant of flooding. Plant in full sun to semi-shade. Takes 8-10 years from seed to fruit production. Regular feeding with balanced fertilizer during growing season beneficial. Excellent for leeward areas with alkaline soils.",
        pest_management: "Relatively pest-free when established. Young trees may be susceptible to scale insects. In some areas, problems with aphids, spider mites, and nematodes reported. Fruit flies can be issue during fruiting season - use male fruit fly traps for control. Strong winds can damage branches - windbreaks recommended in exposed locations. Monitor for typical tropical fruit tree pests during establishment phase.",
        pruning_guidelines: "Minimal pruning required once established due to naturally good structure. Remove dead, damaged, or crossing branches during dormant season. Can be pruned to maintain desired size and shape for easier harvesting. Young trees benefit from training to develop strong scaffold branches. Avoid heavy pruning as it can significantly reduce fruit production. Prune during dry season in Hawaii to reduce disease risk."
    },
    {
        name: "Tamarind",
        ...
        emoji: "🟤",
        rare: false,
        general_info: "Tamarind (*Tamarindus indica*) is a handsome introduced shade tree native to tropical Africa, widely cultivated in tropical regions. Medium-sized evergreen tree reaching 40-80 feet (12-25 meters) tall with rounded crown of dense foliage and trunk diameter of 2-4 feet. Blue-green feathery pinnate leaves with 10-18 pairs of leaflets. Showy pale yellow flowers tinged with red in terminal racemes. Thick brown pods 3-8 inches long containing sour edible pulp surrounding 1-10 seeds. Very hard, heavy wood that takes fine polish, strong and durable though susceptible to dry-wood termites. Introduced to Hawaii in 1797 by Don Marin.",
        cultivation_tips: "Easily propagated from seed with high germination rates. Grows in variety of soil conditions, particularly well-adapted to dry areas where it often escapes cultivation. Tolerates drought conditions exceptionally well once established. Prefers full sun exposure for optimal growth and fruiting. Requires well-drained soils but tolerates various soil types. Can withstand some salt spray in coastal locations. Thrives in leeward areas and planted mainly for shade along roadsides in dry regions. Plant 30-40 feet apart to accommodate mature canopy spread.",
        pest_management: "Generally pest-resistant when established with few serious problems. May be susceptible to dry-wood termites which can damage the valuable wood. Monitor for scale insects and aphids on young growth. Relatively few pest problems reported in Hawaiian conditions. Strong winds can cause branch breakage due to somewhat brittle wood - provide windbreaks in exposed locations. Good sanitation helps prevent pest establishment.",
        pruning_guidelines: "Requires minimal pruning once established due to naturally good structure. Remove dead, damaged, or crossing branches to maintain tree health. Can be pruned to maintain desired shape and size for specific landscape uses. Prune after fruit harvest to maintain tree structure and prepare for next season. Avoid heavy pruning as pod litter can be objectionable in street plantings. Light pruning helps manage size for urban environments while maintaining shade value."
    },
    {
        ...
        emoji: "🍐",
        rare: false,
        general_info: "Guanábana (*Annona muricata*), also known as Soursop, is a tropical evergreen tree producing the largest fruit in the Annonaceae family. Small tree reaching 15-30 feet (4.5-9 meters) tall with trunk diameter of 8-12 inches. Low branching and bushy with upturned limbs and large, simple leaves. Heart-shaped to oval fruits range from few inches to over 1 foot in length, weighing up to 15 pounds. White fruit segments have pleasant sub-acid flavor, most seedless though fertile ones have smooth black seeds. Seeds and bark contain toxic compounds including potentially poisonous alkaloids. Member of custard apple family (Annonaceae).",
        cultivation_tips: "Most drought-tolerant of the annonas, excellent for dry areas. Prefers well-drained soils but tolerates wide range of volcanic soils. Plant 8x8 ft to 20x25 ft spacing for average 100 trees per acre. Quarterly fertilization with 10-10-10 NPK: ½ pound first year, 1 pound second year, 3 pounds thereafter. Requires protection from frost and strong winds. Shallow root system benefits from copious mulching. High temperatures (80-90°F) and low humidity (30%) cause pollination problems; prefers 70s with 80% humidity. Well-suited to protected areas with consistent moisture.",
        pest_management: "Anthracnose (*Colletotrichum gloeosporioides*), bacterial wilt (*Pseudomonas* spp.), black canker (*Phomopsis anonacearum*), diplodia rot (*Botryodiplodia* spp.), and corky rot (*Cylindrocladium colhounii*). Cerconota moth, leaf miner, seed borer, caterpillars, scale insects, Oriental fruit fly, melon fly, and Mediterranean fruit fly. Regular monitoring and integrated pest management approach essential. Harvest timing critical to avoid fruit fly infestation.",
        pruning_guidelines: "Once shaped, requires little pruning other than cutting out dead or poorly placed branches after harvest. Trees can be topped at about 6 feet to cause fruit production on lateral branches and facilitate harvesting. Minimal pruning maintains natural form while improving air circulation. Prune after harvest to prepare for next growing season. Young trees benefit from early shaping to develop strong structure."
    },
    {
        name: "Guava",
        ...
        emoji: "🍐",
        rare: false,
        general_info: "Common Guava (*Psidium guajava*) is a tropical evergreen tree/shrub producing sweet, floral-flavored fruits extremely rich in vitamin C (more than oranges). Small to medium tree reaching 10-33 feet (3-10 meters) tall with trunk diameter of 6-12 inches. Fast-growing especially during warm months, can be shrub-like or tree form. Round to oval fruits with sweet, aromatic flesh. Often have pink flesh and robust, slightly tart flavor ideal for jams and jellies. In winter, leaves turn purple/red and growth stops. Can be invasive in some tropical regions due to aggressive spreading and bird-dispersed seeds.",
        cultivation_tips: "Thrives in any soil with good drainage, very adaptable to various soil types. Full sun for best flowering and fruit production. Requires cold protection, not suitable outdoors in most US zones except Hawaii, Virgin Islands, Florida, and sheltered areas in California/Texas. Fertilize every 1-2 months while young, then 3-4 times per year as tree matures. Needs high nitrogen, phosphoric acid, potash, plus magnesium. 6-6-6-2 worked into soil before growing season. Thrives in most Hawaiian conditions from sea level to moderate elevations.",
        pest_management: "Relatively hardy with good natural resistance. Susceptible to fruit flies - use male fruit fly traps for control. Can affect young growth - monitor and treat as needed. In coastal areas, salt winds can burn leaves but tree recovers with new growth. Monitor for aphids and spider mites. Fruit should be picked when just changing from green to light yellow to avoid fruit fly larvae infestation.",
        pruning_guidelines: "Responds very well to pruning to keep compact and manageable. Can be kept small for container growing or even pruned as bonsai. Regular pruning helps maintain desired shape and improves air circulation. Prune after fruiting season for best results. Remove dead, damaged, or crossing branches. Can be trained as single or multi-trunk specimens depending on desired form."
    },
    {
        name: "Coconut",
        ...
        emoji: "🥥",
        rare: false,
        general_info: "Coconut (*Cocos nucifera*) is a large palm native to the Central Indo-Pacific region, carried by Polynesians to Hawaii. Grows up to 100 feet (30 meters) tall with trunk diameter of 1-2 feet. Single trunk topped with crown of pinnate leaves 13-20 feet (4-6m) long. On fertile soil, can yield up to 75 fruits per year. Produces first fruit in 6-10 years, reaching peak production after 15-20 years. Nearly cosmopolitan due to human cultivation and natural oceanic dispersal. Symbol of tropics, excellent for preventing beach erosion, provides food, water, fiber, and building materials.",
        cultivation_tips: "Requires direct sun for optimal growth and fruit production. Warm temperatures essential (minimum 64°F for fruit production). High humidity preferred. Thrives in well-drained, fertile soil but remarkably tolerates sandy, poor soils and salt spray. Needs continuous water supply to keep soil moist but cannot tolerate waterlogging. Plant in spring, transplant during warmest, rainiest months. Provide inch of water weekly after planting. Apply mulch to retain moisture and suppress weeds. Thrives in coastal areas with natural salt tolerance.",
        pest_management: "Susceptible to lethal yellowing disease spread by leafhoppers - choose resistant varieties like 'Maypan'. Palm leaf skeletonizer, aphids, nematodes, spider mites, scale, and coconut leaf beetle (*Brontispa longissima*). In Florida, thousands killed by lethal yellowing disease. Watch for yellowing diseases affecting coconut plantations worldwide. Generally fewer pest problems in Hawaiian conditions but monitor for introduced pests.",
        pruning_guidelines: "Requires very little pruning intervention. Only remove completely brown, dead fronds - never remove yellowing fronds as they provide essential nutrients to tree. Avoid 'hurricane cuts' or removing green fronds which severely weakens the palm. Maintain 6-8 green fronds above newest emerging frond. Improper pruning weakens tree and makes it highly susceptible to pests and diseases."
    },
    {
        name: "Papaya",
        ...
        emoji: "🧡",
        rare: false,
        general_info: "Papaya (*Carica papaya*) is a herbaceous perennial plant with a hollow trunk native to lowland tropical Central and South America. Reaches up to 20 feet (6 meters) tall with trunk diameter of 6-8 inches, crowned with large palmate leaves. Cultivated in Hawaii since early 1800s. Solo varieties are small enough for one person (1-3 pounds) with either red or yellow flesh. Trees are dioecious with female and hermaphrodite plants; hermaphrodite preferred commercially for pear-shaped fruits. Matures in 6-9 months in warmer regions, 9-11 months in cooler areas. Can produce up to 100 fruits per growing season under optimal conditions.",
        cultivation_tips: "Grows best below 500 ft elevation in warm areas with 40-60 inches annual rainfall. Full sun, well-drained soil, and protection from winds exceeding 40 mph essential. Plant 4-5 feet apart in rows 15-20 feet apart for commercial production. Commercial production limited to minimum temperatures above 60°F (15°C). Fertilize every 2 weeks (ground trees) or 10 days (potted plants) with phosphorus-dominant fertilizer. Critical - waterlogging can kill plants in hours. Salt spray and saline soils are detrimental. Thrives in protected leeward locations with good drainage.",
        pest_management: "Papaya Ringspot Virus (PRV) - use genetically resistant cultivars like 'Rainbow' and 'UH SunUp'. Preventative mancozeb applications every 2-3 weeks in high rainfall areas. Stevens leafhopper, white peach scale, fruit flies (Mediterranean, Oriental, Melon), mealybugs, and various mites. Slugs damage fruit and must be controlled. Use approved disinfestation treatments for export fruit. PRV resistance critical for successful cultivation.",
        pruning_guidelines: "Allow only one main trunk for best fruit quality and size. Remove shoots around base except for one replacement shoot in September. Cut fruited trunk back to stump after harvest, allowing replacement shoot to become new main plant. Avoid cutting hollow trunk as water entry causes rot. Trim leaves only when petioles rub against fruits or interfere with spraying operations."
    },
    {
        name: "Mulberry",
        botanical: "Morus",
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        general_info: "Vanilla (*Vanilla planifolia*) is a climbing orchid vine native to Mexico and Central America, the primary source of natural vanilla flavor. Vines can reach 50-100 feet (15-30 meters) in length when climbing trees, with stems 0.5-1 inch diameter. Epiphytic climbing vine using aerial roots to adhere to support structures. Name derives from Spanish 'vainilla' meaning 'little pod.' Requires hand pollination in Hawaii since natural pollinators (euglossine bees) absent. Greenish-white flowers open at 6 AM, close by early afternoon - only 36-hour pollination window. Hawaiian vanilla has honey and chocolate fragrance notes with floral, complex, naturally sweet profile securing top connoisseur status. Takes 2-4 years to mature, beans develop 5 months after pollination.",
        cultivation_tips: "Partial shade with 50% sun exposure essential - protect from strong winds. Rich, well-draining soil with high organic content and consistent moisture. Provide bamboo trellises or living trees - prefers growing on living trees with bark for root adherence. Maintain soil pH 6.0-7.0 for optimal growth. Apply balanced NPK during growth and fruit development. Warm temperatures, ample rainfall, and fertile volcanic soil create excellent conditions. Required in Hawaii - flowers open around 6 AM for only few hours. Beans require careful curing process involving blanching and drying to 30-35% moisture content. Allow adequate space for mature vine size.",
        pest_management: "Generally robust with few major pest issues in Hawaii. Monitor for scale insects, aphids, and spider mites common to orchids. Ensure excellent air circulation to prevent fungal issues in humid conditions. Root rot possible with poor drainage or overwatering. Strong aerial root system helps prevent mechanical damage. Regular inspection and removal of dead or diseased plant material prevents disease spread. Generally pest-free but monitor during wet seasons.",
        pruning_guidelines: "Train vines on support structures to manageable heights for hand pollination and harvesting accessibility. Remove dead, diseased, or excess vegetative growth regularly. Prune to maintain good airflow and light penetration. Since flowers emerge from vine nodes, avoid excessive pruning of mature vine sections. Allow vines to establish on support before heavy pruning. Regular light pruning preferred over heavy annual cuts. Prune after harvest season in Hawaii to prepare for next flowering cycle."
    },
    {
        ...
        emoji: "🌿",
        rare: false,
        general_info: "Horseradish Tree (*Moringa oleifera*) is a fast-growing, drought-resistant deciduous tree known as the 'miracle tree' or 'Tree of Life' for its exceptional nutritional value. Reaches 33-40 feet (10-12 meters) tall with trunk diameter of 8-12 inches and white-gray corky bark. Can grow up to 8 feet per year with amazing resilience to regrow when cut. Trees regularly cut to knee-chest height for easier harvesting. Produces fragrant cream-white flowers in panicles. Long seed pods (drumsticks) are edible when young. Common in Hawaiian Filipino communities for culinary and medicinal purposes. Leaves extremely rich in vitamins A, C, calcium, iron, and protein.",
        cultivation_tips: "Grows best in neutral to slightly acidic soil (pH 6.3-7.0), well-drained sandy or loamy soil essential. Sun and heat-loving plant that does not tolerate freezing or frost. Particularly suitable for dry regions - can be grown using rainwater without expensive irrigation. Prefers 77-95°F (25-35°C), tolerates up to 118°F (48°C) with afternoon shade. Water daily while young, becomes drought-tolerant when established. Apply controlled-release fertilizer twice yearly in late winter and late summer. Thrives in leeward areas and excellent for sustainable food production.",
        pest_management: "Not affected by serious diseases under proper conditions. May be attacked by aphids, caterpillars, and fruit flies in warm climates. Use pyrethrum-based insecticides for aphids and caterpillars. In waterlogged soil, roots have tendency to rot - ensure excellent drainage. Generally pest-free once established. Birds may eat seeds and spread plants naturally. Very few pest problems in Hawaiian conditions.",
        pruning_guidelines: "Regular pruning essential to prevent tree becoming too tall and increase harvest yield. Prune during dormant season before new growth starts. When 30-36 inches tall, cut back to 18-24 inches leaving 4-5 branches in vase form. When branches reach 8-10 feet, top to eye level for easier harvesting. Remove shoots growing straight up and crossing/dead branches. Cut regularly between knee and chest height for continuous leaf production and easier harvesting."
    },
    {
        name: "Cardamom",
    ...
    },
    {
        ...
        category: "herbs,ornamental",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Zingiber_officinale_plant.jpg/512px-Zingiber_officinale_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Zingiber_officinale_flower.jpg/512px-Zingiber_officinale_flower.jpg",
        emoji: "🫚",
        rare: false,
    ...
    },
    {
        ...
        emoji: "🌿",
        rare: true,
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/2/2a/Calea_ternifolia.jpg",
    ...
    },
    {
        ...
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Ocimum_basilicum_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-025.jpg/512px-Ocimum_basilicum_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-025.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Basil-flowers.jpg/512px-Basil-flowers.jpg",
        emoji: "🌿",
        rare: false,
    ...
    },
    {
        ...
        category: "herbs",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Thymus_vulgaris_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-245.jpg/512px-Thymus_vulgaris_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-245.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Thymus_vulgaris_flowers.jpg/512px-Thymus_vulgaris_flowers.jpg",
        emoji: "🌿",
        rare: false,
    ...
    },
    {
        ...
        category: "herbs",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Rosmarinus_officinalis_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-091.jpg/512px-Rosmarinus_officinalis_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-091.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Rosmarinus_officinalis_flowers.jpg/512px-Rosmarinus_officinalis_flowers.jpg",
        emoji: "🌿",
        rare: false,
    ...
    },
    {
        ...
        category: "herbs",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Origanum_vulgare_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-019.jpg/512px-Origanum_vulgare_-_K%C3%B6hler%E2%80%93s_Medizinal-Pflanzen-019.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Origanum_vulgare_flowers.jpg/512px-Origanum_vulgare_flowers.jpg",
        emoji: "🌿",
        rare: false,
    ...
    },
    {
        ...
        category: "herbs",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Eryngium_foetidum_plant.jpg/512px-Eryngium_foetidum_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Eryngium_foetidum_flowers.jpg/512px-Eryngium_foetidum_flowers.jpg",
        emoji: "🌿",
        rare: false,
    ...
    },
    {
        ...
        category: "carnivorous",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Nepenthes_ampullaria_plant.jpg/512px-Nepenthes_ampullaria_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Nepenthes_ampullaria_pitchers.jpg/512px-Nepenthes_ampullaria_pitchers.jpg",
        emoji: "🌸",
        rare: true,
    ...
    },
    {
        ...
        category: "carnivorous",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Nepenthes_miranda_plant.jpg/512px-Nepenthes_miranda_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Nepenthes_miranda_pitcher.jpg/512px-Nepenthes_miranda_pitcher.jpg",
        emoji: "🌸",
        rare: true,
    ...
    },
    {
        ...
        category: "carnivorous",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Nepenthes_ventricosa_plant.jpg/512px-Nepenthes_ventricosa_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Nepenthes_ventricosa_pitcher.jpg/512px-Nepenthes_ventricosa_pitcher.jpg",
        emoji: "🌸",
        rare: true,
    ...
    },
    {
        ...
        category: "carnivorous",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Nepenthes_mirabilis_plant.jpg/512px-Nepenthes_mirabilis_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Nepenthes_mirabilis_pitcher.jpg/512px-Nepenthes_mirabilis_pitcher.jpg",
        emoji: "🌸",
        rare: true,
    ...
    // ORNAMENTAL
    {
        ...
        category: "ornamental", 
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Hoya_pubicalyx_plant.jpg/512px-Hoya_pubicalyx_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Hoya_pubicalyx_flowers.jpg/512px-Hoya_pubicalyx_flowers.jpg",
        emoji: "🌺", 
        rare: false,
    ...
    // WISHLIST
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Clausena_lansium_tree.jpg/512px-Clausena_lansium_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Clausena_lansium_flowers.jpg/512px-Clausena_lansium_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Clausena_lansium_fruits.jpg/512px-Clausena_lansium_fruits.jpg",
        emoji: "🍇",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Theobroma_grandiflorum_tree.jpg/512px-Theobroma_grandiflorum_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Theobroma_grandiflorum_flower.jpg/512px-Theobroma_grandiflorum_flower.jpg",
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Myrciaria_dubia_plant.jpg/512px-Myrciaria_dubia_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Myrciaria_dubia_flowers.jpg/512px-Myrciaria_dubia_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Myrciaria_dubia_fruits.jpg/512px-Myrciaria_dubia_fruits.jpg",
        emoji: "🔴",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Barringtonia_edulis_tree.jpg/512px-Barringtonia_edulis_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Barringtonia_edulis_flowers.jpg/512px-Barringtonia_edulis_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Barringtonia_edulis_fruit.jpg/512px-Barringtonia_edulis_fruit.jpg",
        emoji: "🌰",
        rare: true,
    ...
    },
    {
        ...
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Artocarpus_sericicarpus_flowers.jpg/512px-Artocarpus_sericicarpus_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Artocarpus_sericicarpus_fruit.jpg/512px-Artocarpus_sericicarpus_fruit.jpg",
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Sterculia_quadrifida_tree.jpg/512px-Sterculia_quadrifida_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Sterculia_quadrifida_flowers.jpg/512px-Sterculia_quadrifida_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Sterculia_quadrifida_pods.jpg/512px-Sterculia_quadrifida_pods.jpg",
        emoji: "🥜",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Sterculia_monosperma_tree.jpg/512px-Sterculia_monosperma_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Sterculia_monosperma_flowers.jpg/512px-Sterculia_monosperma_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Sterculia_monosperma_pods.jpg/512px-Sterculia_monosperma_pods.jpg",
        emoji: "🌰",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Solanum_quitoense_plant.jpg/512px-Solanum_quitoense_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Solanum_quitoense_flowers.jpg/512px-Solanum_quitoense_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Solanum_quitoense_fruits.jpg/512px-Solanum_quitoense_fruits.jpg",
        emoji: "🟠",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Muntingia_calabura_tree.jpg/512px-Muntingia_calabura_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Muntingia_calabura_flowers.jpg/512px-Muntingia_calabura_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Muntingia_calabura_fruits.jpg/512px-Muntingia_calabura_fruits.jpg",
        emoji: "🍓",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Pandanus_tectorius_tree.jpg/512px-Pandanus_tectorius_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Pandanus_tectorius_flowers.jpg/512px-Pandanus_tectorius_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Pandanus_tectorius_fruit.jpg/512px-Pandanus_tectorius_fruit.jpg",
        emoji: "🌴",
        rare: false,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Passiflora_morifolia_vine.jpg/512px-Passiflora_morifolia_vine.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Passiflora_morifolia_flower.jpg/512px-Passiflora_morifolia_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Passiflora_morifolia_fruit.jpg/512px-Passiflora_morifolia_fruit.jpg",
        emoji: "🔵",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Garcinia_cowa_tree.jpg/512px-Garcinia_cowa_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Garcinia_cowa_flowers.jpg/512px-Garcinia_cowa_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Garcinia_cowa_fruits.jpg/512px-Garcinia_cowa_fruits.jpg",
        emoji: "🟡",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Vanilla_pompona_vine.jpg/512px-Vanilla_pompona_vine.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Vanilla_pompona_flower.jpg/512px-Vanilla_pompona_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Vanilla_pompona_pods.jpg/512px-Vanilla_pompona_pods.jpg",
        emoji: "🌿",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Vanilla_tahitensis_vine.jpg/512px-Vanilla_tahitensis_vine.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Vanilla_tahitensis_flower.jpg/512px-Vanilla_tahitensis_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Vanilla_tahitensis_pods.jpg/512px-Vanilla_tahitensis_pods.jpg",
        emoji: "🌿",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Oroxylum_indicum_tree.jpg/512px-Oroxylum_indicum_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Oroxylum_indicum_flowers.jpg/512px-Oroxylum_indicum_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Oroxylum_indicum_pods.jpg/512px-Oroxylum_indicum_pods.jpg",
        emoji: "🌺",
        rare: true,
    ...
    },
    {
        ...
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Pachira_aquatica_flowers.jpg/512px-Pachira_aquatica_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Pachira_aquatica_pods.jpg/512px-Pachira_aquatica_pods.jpg",
    ...
    },
    {
        ...
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Plukenetia_volubilis_flowers.jpg/512px-Plukenetia_volubilis_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Plukenetia_volubilis_pods.jpg/512px-Plukenetia_volubilis_pods.jpg",
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/Syzygium_cumini_tree.jpg/512px-Syzygium_cumini_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Syzygium_cumini_flowers.jpg/512px-Syzygium_cumini_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Syzygium_cumini_fruits.jpg/512px-Syzygium_cumini_fruits.jpg",
        emoji: "🫐",
        rare: false,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Passiflora_maliformis_vine.jpg/512px-Passiflora_maliformis_vine.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Passiflora_maliformis_flower.jpg/512px-Passiflora_maliformis_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Passiflora_maliformis_fruit.jpg/512px-Passiflora_maliformis_fruit.jpg",
        emoji: "🍈",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Nephelium_hypoleucum_tree.jpg/512px-Nephelium_hypoleucum_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Nephelium_hypoleucum_flowers.jpg/512px-Nephelium_hypoleucum_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Nephelium_hypoleucum_fruits.jpg/512px-Nephelium_hypoleucum_fruits.jpg",
        emoji: "🍇",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Aframomum_alboviolaceum_plant.jpg/512px-Aframomum_alboviolaceum_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Aframomum_alboviolaceum_flower.jpg/512px-Aframomum_alboviolaceum_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Aframomum_alboviolaceum_seeds.jpg/512px-Aframomum_alboviolaceum_seeds.jpg",
        emoji: "🫚",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Carica_weberbaueri_tree.jpg/512px-Carica_weberbaueri_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Carica_weberbaueri_flowers.jpg/512px-Carica_weberbaueri_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Carica_weberbaueri_fruit.jpg/512px-Carica_weberbaueri_fruit.jpg",
        emoji: "🧡",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Jaltomata_procumbens_plant.jpg/512px-Jaltomata_procumbens_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Jaltomata_procumbens_flower.jpg/512px-Jaltomata_procumbens_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Jaltomata_procumbens_fruit.jpg/512px-Jaltomata_procumbens_fruit.jpg",
        emoji: "🍅",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Musella_lasiocarpa_plant.jpg/512px-Musella_lasiocarpa_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Musella_lasiocarpa_flower.jpg/512px-Musella_lasiocarpa_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Musella_lasiocarpa_fruit.jpg/512px-Musella_lasiocarpa_fruit.jpg",
        emoji: "🍌",
        rare: true,
    ...
    },
    {
        ...
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Averrhoa_bilimbi_tree.jpg/512px-Averrhoa_bilimbi_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Averrhoa_bilimbi_flowers.jpg/512px-Averrhoa_bilimbi_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Averrhoa_bilimbi_fruits.jpg/512px-Averrhoa_bilimbi_fruits.jpg",
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Aframomum_sulcatum_plant.jpg/512px-Aframomum_sulcatum_plant.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Aframomum_sulcatum_flower.jpg/512px-Aframomum_sulcatum_flower.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Aframomum_sulcatum_seeds.jpg/512px-Aframomum_sulcatum_seeds.jpg",
        emoji: "🫚",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/a/a8/Guaran%C3%A0_original_do_Brasil.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/2/29/Guaran%C3%A1_02.jpg",
        emoji: "🔴",
        rare: true,
    ...
    },
    {
        ...
        category: "wishlist",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Couroupita_guianensis_tree.jpg/512px-Couroupita_guianensis_tree.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Couroupita_guianensis_flowers.jpg/512px-Couroupita_guianensis_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Couroupita_guianensis_fruits.jpg/512px-Couroupita_guianensis_fruits.jpg",
        emoji: "🌺",
        rare: true,
    ...
    },
    {
        ...
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Eugenia_stipitata_flowers.jpg/512px-Eugenia_stipitata_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Eugenia_stipitata_fruits.jpg/512px-Eugenia_stipitata_fruits.jpg",
        emoji: "🟡",
        rare: true,
        general_info: "Araza (*Eugenia stipitata*) is a fruit tree native to the Amazon Rainforest in Brazil, Colombia, Peru and Ecuador. Shrub or small tree growing 2.5-15 meters tall with densely branched canopy. Simple, opposite, elliptical leaves 8-19 by 3.5-9.5 cm with dark green color and impressed lateral veins. Globose to oblate berry, 2-10 x 2-12 cm, weighing up to 750g. Pale green ripening to bright yellow with thin, velvety skin. Juicy, aromatic, acidic thick pulp with sweet-sour taste. Contains usually 12 seeds. High in phosphorus, iron, and vitamin C. Processed into juices, nectars, marmalades, ice-creams due to very acidic nature when fresh.",
        cultivation_tips: "Requires humid tropical climate similar to Amazon conditions. Grows on old, non-floodable terraces in tropical, white, highly leached podzolic soils with good drainage. Tolerates partial shade but produces better in more light. Well-suited to Hawaii's humid climate, especially at higher elevations with consistent moisture. Consistent moisture essential but avoid waterlogging. 15-20 feet apart due to compact size. Trees begin fruiting relatively quickly after establishment. Very acidic fruit requires processing for palatability.",
        pest_management: "Monitor for typical tropical fruit tree pests like scale insects and fruit flies. Ensure good air circulation in humid conditions. Watch for introduced pests common to Myrtaceae family plants. Protect from strong winds and salt spray. Maintain good drainage while keeping soil consistently moist.",
        pruning_guidelines: "Prune during dry periods to reduce disease risk. Shape young trees to develop strong branched framework. Remove dead, diseased, or crossing branches. Light pruning to maintain manageable height for fruit harvesting. Prune to improve airflow in humid conditions. Focus on developing strong scaffold branches for fruit production."
    },
    {
        name: "Jabuticaba (Brazilian Grape Tree)",
        botanical: "Plinia cauliflora",
        category: "fruit",
        info_url: "https://en.wikipedia.org/wiki/Jabuticaba",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/6/62/Jabuticaba_%281%29.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Plinia_cauliflora_flowers.jpg/512px-Plinia_cauliflora_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Plinia_cauliflora_fruits.jpg/512px-Plinia_cauliflora_fruits.jpg",
        emoji: "🍇",
        rare: true,
        general_info: "Jabuticaba (*Plinia cauliflora*), also known as Brazilian Grape Tree, is a unique tropical fruit tree native to Brazil. Slow-growing evergreen that can reach 15 meters (49 ft) if not pruned. Exhibits cauliflory - fruits grow directly on the trunk and branches, making it visually striking. Round, purplish-black fruits 3-4 cm in diameter with white or rosy pink gelatinous flesh. Sweet, grape-like taste with astringent skin. May flower and fruit 5-6 times per year in native habitat. Name derives from Tupi word meaning 'place where tortoises are found' or 'like turtle fat' referring to white pulp. Eaten fresh or made into jellies, jams, juice, or wine.",
        cultivation_tips: "Tropical to subtropical, tolerates mild frosts down to -3°C (26°F). Prefers moist, rich, lightly acidic soil but adaptable to alkaline beach-sand soils with irrigation. Full sun to partial shade. Well-suited to Hawaii's climate, excellent for container growing due to compact fibrous root system. Requires consistent moisture, drought tolerant but fruit production reduced. Compact root system makes it suitable for pots or close planting. Grafted plants fruit in 5 years, seed-grown trees take 10-20 years. Excellent choice for large containers due to fibrous root system.",
        pest_management: "Vulnerable to rust (*Austropuccinia psidii*) especially during flowering in heavy rain. Canker (*Colletotrichum gloeosporioides*), dieback (*Rosellinia*), and fruit rot (*Botrytis cinerea*). Monitor for introduced tropical fruit pests. Intolerant of salty soils or salt spray. Ensure good air circulation during wet periods, avoid overhead watering during flowering. Regular inspection for fungal issues in humid conditions.",
        pruning_guidelines: "Regular pruning to maintain manageable size and attractive form. Remove dead, diseased, or crossing branches. Can be kept smaller through pruning, excellent for bonsai cultivation. Prune to improve airflow and reduce disease risk. Prune after fruiting periods. Pruning enhances the unique trunk-fruiting display. Regular pruning essential for pot-grown specimens."
    },
    {
        name: "Star Apple (Caimito)",
        botanical: "Chrysophyllum cainito",
        category: "fruit",
        info_url: "https://en.wikipedia.org/wiki/Chrysophyllum_cainito",
        plant_photo: "https://upload.wikimedia.org/wikipedia/commons/2/2e/Starr_070906-8589_Chrysophyllum_cainito.jpg",
        flower_photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Chrysophyllum_cainito_flowers.jpg/512px-Chrysophyllum_cainito_flowers.jpg",
        fruit_photo: "https://upload.wikimedia.org/wikipedia/commons/e/ea/Chrysophyllum_cainito0.jpg",
        emoji: "⭐",
        rare: true,
        general_info: "Star Apple (*Chrysophyllum cainito*) is a tropical tree native to the Isthmus of Panama, now grown throughout the tropics. Fast-growing tree reaching 20 meters in height. Evergreen leaves with golden underside that shines when viewed from distance. Globose fruits 2-3 inches in diameter, typically purple with radiating star pattern visible in pulp. Purple (most common), greenish-brown (thin skin, liquid pulp), and yellow (less common). Sweet dessert fruit, often served chilled. Hermaphroditic (self-fertile) with tiny purplish-white fragrant flowers. Name likely from Mayan words meaning 'breast juice sap'. Primarily eaten fresh as dessert fruit.",
        cultivation_tips: "Tropical, grows rapidly in warm humid conditions. Adaptable to various soil types, prefers well-drained fertile soil. Full sun for best fruit production. Well-suited to Hawaii's tropical climate, thrives at sea level to moderate elevations. Regular watering during establishment, somewhat drought tolerant once mature. Allow 20-30 feet between trees due to large mature size. Self-fertile, begins fruiting relatively quickly after establishment. Seasonal fruit bearing tree with distinct harvest periods.",
        pest_management: "Monitor for typical tropical fruit tree pests. Fruit skin rich in latex - handle carefully during harvest. Generally hardy with good natural disease resistance. Watch for introduced fruit flies and scale insects. Protect young trees from strong winds. Regular inspection and removal of damaged or diseased fruit.",
        pruning_guidelines: "Regular pruning to control large size and improve harvest access. Develop strong scaffold branches to support heavy fruit loads. Prune to improve airflow and light penetration. Prune after harvest season. Use caution due to latex in plant parts. Pruning maintains attractive canopy shape and enhances golden leaf undersides. Selective pruning can improve fruit quality and size."
    },
    {
        name: "Lychee",
        ...
        emoji: "🍇",
        rare: true,
        general_info: "Lychee (*Litchi chinensis*) is a monotypic taxon and sole member of genus *Litchi* in the soapberry family Sapindaceae. Tall evergreen tree native to South China, Malaysia, and northern Vietnam. Three distinct subspecies - Indochinese (most common), Philippine (*alupag* or *matamata*), and Javanese. Small fleshy sweet drupes with pink-red, rough-textured soft shell. Sweet, aromatic flesh with floral notes. China is main producer, followed by India and Vietnam. Cultivation documented in China from 11th century. Widely cultivated throughout Southeast Asia and South Asia. Seeds contain compounds that can cause hypoglycemia in undernourished children.",
        cultivation_tips: "Tropical to subtropical, requires warm humid conditions. Well-drained, slightly acidic soil preferred. Full sun for best fruit production. Well-suited to Hawaii's climate, especially at elevations with good drainage. Consistent moisture during growing season, reduce during dormancy. Allow adequate space for large mature size. Trees begin fruiting after several years from grafting. Benefits from cross-pollination for better fruit set. Fruits ripen in clusters, harvest when fully colored.",
        pest_management: "Generally hardy but monitor for fungal issues in humid conditions. Watch for scale insects, aphids, and fruit flies. Monitor for introduced pests common to tropical fruit trees. Protect from strong winds that can damage branches. Handle seeds carefully due to toxic compounds. Good air circulation and proper spacing reduce disease risk.",
        pruning_guidelines: "Regular pruning to maintain manageable size and attractive form. Develop strong framework to support heavy fruit clusters. Prune to improve airflow and reduce disease risk. Prune after harvest season. Can be kept smaller through regular pruning. Selective pruning improves fruit quality and harvest access. Use proper tools and techniques for large tree pruning."
    },
    {
        name: "Sapodilla",
        botanical: "Manilkara zapota",
        ...
        emoji: "🟤",
        rare: true,
        general_info: "Sapodilla (*Manilkara zapota*), also known as sapote, chicozapote, chicoo, naseberry, or soapapple, is an evergreen tree native to southern Mexico and Central America. Can grow over 30m (98 ft) tall with trunk diameter up to 1.5m (5 ft), but cultivated specimens average smaller. Trees can live up to 100 years. Brown, rough-skinned oval fruits with sweet, malty flavor and grainy texture. Introduced to Philippines during Spanish colonization, now grown throughout tropical Asia. Name derives from Spanish 'little sapote', ultimately from Nahuatl 'tzapotl'. Grown in large quantities in Mexico, India, Thailand, Malaysia, and Caribbean. Eaten fresh, made into desserts, and historically source of chicle for chewing gum.",
        cultivation_tips: "Tropical, requires consistently warm temperatures. Adaptable to various soil types, prefers well-drained fertile soil. Full sun for best fruit production. Well-suited to Hawaii's tropical climate, thrives at sea level to moderate elevations. Regular watering during establishment, drought tolerant once mature. Allow adequate space for large mature size. Trees begin fruiting after several years, can produce for decades. Fruits ripen year-round in tropical climates. Slow-growing but long-lived and productive.",
        pest_management: "Generally hardy with good natural disease resistance. Monitor for scale insects, fruit flies, and mealybugs. Watch for introduced tropical fruit pests. Protect young trees from strong winds. Regular inspection and removal of damaged fruit. Good air circulation and proper spacing reduce disease risk. Long-lived trees with strong natural pest resistance.",
        pruning_guidelines: "Regular pruning to control large size and improve harvest access. Develop strong scaffold branches for long-term fruit production. Prune to improve airflow and light penetration. Prune during dry periods to reduce disease risk. Light pruning to maintain tree health for decades of production. Use proper equipment for large tree pruning. Selective pruning improves fruit quality and ease of harvest."
    },
    {
        name: "Mangosteen",
        botanical: "Garcinia mangostana",
        ...
        emoji: "👑",
        rare: true,
        general_info: "Mangosteen (*Garcinia mangostana*), known as the 'Queen of Fruits', is a tropical evergreen tree native to Island Southeast Asia. Grows 6-25 meters (20-82 ft) tall with dense, pyramidal crown. Deep purple rind when ripe containing sweet, tangy, juicy white flesh segments. Considered one of the world's finest fruits with complex sweet-tart flavor. Cultivated extensively in tropical Asia since ancient times. Highly prized throughout Southeast Asia, often called the queen of tropical fruits. Grown mainly in Southeast Asia, with introductions to Colombia, Puerto Rico, and Florida. Fruit develops without fertilization (agamospermy). Commands high prices in international markets.",
